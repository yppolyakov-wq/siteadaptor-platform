...
- **Самое свежее (2026-08-05, ночь, финал): ВОЛНА W12 «честные режимы» ЗАКРЫТА
  ...
  **Итог программы W-v3 (один день, всё БЕЗ миграций):** W7 предохранители →
  ...
  владельца:** ответ на BusinessReview (миграция SHARED-поля) · W11-5
  Website-свод в Studio (отдельная сессия с план-доком) · де-факто новые экраны —
  прогнать глазами на стенде.
- **Самое свежее (2026-08-06): решения владельца 1а/3/4а/5а по хвостам аудита — в main
  ...
  admin/staff пока идентичны (решение «оставить как есть»). **2а** W11-5 Website-свод —
  отдельной сессией (промпт передан владельцу).
