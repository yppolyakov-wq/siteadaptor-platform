...
- **Самое свежее (2026-09-03, вечер): ВОЛНА STU «переработка Студии» ИСПОЛНЕНА ЦЕЛИКОМ
  ...
  **STU-7 ✅ (2026-09-04):** записанное «ограничение v1» оказалось ДЕФЕКТОМ шире — query
  ...
  страницу без группы — класс `/galerie/`); замер вместо догадки — 70 страниц витрины из 70
  тип сообщают, исключение только кастомный 404 (standalone НАМЕРЕННО, SF-3) → пустой тип =
