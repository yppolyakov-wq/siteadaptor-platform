...
- **Самое свежее (2026-07-02): Волна U-B (единый листинг/категории/фасеты) — закрыта, кроме UB3-2.**
  ...
  **UB2-3 ✅** фасеты цена/наличие (перенос из вьюхи) / Herkunft (`Product.origin`) / рейтинг
  ...
  первыми — в каркасе с UB1-3, замок в test_listing_parity). Всё FF-мержено в `main` по зелёным CI;
  **миграций НЕТ**. **UB3-2 (M2M `Collection`, миграция)** — мини-разведка
  `docs/ub3-2-collection-recon-2026-07-02.md` НА СОГЛАСОВАНИИ владельца, код не начат.
  Ветка волны — `claude/wave-ub-unified-listing-kmcg33`. Дальше после U-B: **U-C** (универсальный
  редактор) — либо L4 (i18n-хром) / E-2 (правовой пакет) по выбору владельца.
...
**Статус U-B (2026-07-02):** UB1-1/1-2/1-3 ✅ (каркас listing.html + единая карточка + свод
4 листингов), UB2-1/2-2/2-3 ✅ (FacetProvider + поиск/сорт + фасеты цена/наличие/Herkunft/рейтинг),
UB3-1 ✅. Остаток: **UB3-2 (M2M Collection, миграция)** — разведка
`docs/ub3-2-collection-recon-2026-07-02.md` на согласовании владельца (§7 вопросы 1–4 там).
