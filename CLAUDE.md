...
- **Самое свежее (2026-09-03, вечер): ВОЛНА STU «переработка Студии» ИСПОЛНЕНА ЦЕЛИКОМ
  ...
  **оставлены осознанно** `/dashboard/design/` (создан DL-7b как ответ на ту же жалобу,
  ...
  (эвристика «нет группы и нет хоста → главная» заменена на тип страницы). Ограничения
  v1: `?page=` отбрасывает query (санитайзер T-6.1) — страница группы акций открывается
  кликом по чипу; на 404 внутри канвы тип неизвестен.
