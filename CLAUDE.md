...
- **Самое свежее (2026-07-13): AB6.1 ✅ — движок шагов мастера (state v2 + рельса ✓/⏭ + ?step=).**
  ...
  (вёрстка 1:1); app.css пересобран. Состав шагов пока прежний (7); целевая карта 8 слайдов —
  **AB6.2 (следующий)**, затем AB7.1/7.2 (блочная главная+канбан) → AB6.3…AB6.8. Без миграций.
