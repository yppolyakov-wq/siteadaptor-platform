...
- **Самое свежее (2026-09-10): волна LAY продолжена — LAY-6a/6b (язык редактора) + LAY-3a-2
  ...
  **ВОЛНА LAY ЗАКРЫТА ЦЕЛИКОМ (LAY-1…LAY-6):** три ортогональные оси вывода — композиция ·
  ...
  литерала ОБРАТНАЯ (метит стиль с жёсткой сеткой), общий фикс сделал бы его там мёртвым. ⏸ **За
  решением владельца (LAY-7c):** на /aktionen/ два контрола одного смысла — ось
  «Ausgabe: Slider» и «Darstellung der Gruppen» (`promo_layout`); снос видимого контрола —
  его call, варианты в плане §14.3.
