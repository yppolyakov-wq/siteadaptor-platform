...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.aggregator.context.shortlist",  # MEN-12: отложенное/сравнение
...
CELERY_BEAT_SCHEDULE = {
    ...
    "auto-fulfil-stays": {
        "task": "apps.stays.tasks.auto_fulfil_stays",
        "schedule": 86400.0,  # раз в сутки — PMS-B2: авто-выселение прошедших броней
    },
