...
- **W11-3 ✅** (2026-08-05): вкладка «Über den Betrieb» на экране Bewertungen
  ...
  **Дополнено решением 1а (2026-08-06): ответ СДЕЛАН** — reply_text/replied_at
  (⚠️ миграция aggregator/0016), форма в кабинете + показ на портале,
  анти-кросс-тенант 404 замком.
- **W11-4 ✅** (2026-08-05): акция на услугу/номер/комбо из UI. PromotionForm
  ...
  test_w11_targets.
- **W11-5 ✅ (2026-08-06, решение владельца 2а — полный свод):** страница «Site»
  умерла; quick-start (шаблоны + демо) — область рейки Studio, hero_image/
  quick_add — форма билдера (live-черновик), gallery_video — область «Медиа»,
  соседние экраны получили входы, `/dashboard/site/` = 302 с GET-carry, все
  консумеры «Website» ведут в Studio. План+статус —
  `w11-5-website-studio-plan-2026-08-06.md`; Playwright 28/28 (нашёл дефект
  видимости quick_add в Простом режиме — исправлен). БЕЗ миграций.
  Разведка 2026-08-05 (историческая): site.html —
  не «пустой лендинг», а функциональная страница: quick-start (шаблоны+демо),
  галерея-аплоад (multipart), тексты welcome/quick_add, POST-ветки site_view.
  Полный «слив в Studio» = перенос этих форм в рейку site_home.html (3400 строк,
  самый нагруженный шаблон, двойная буферизация/draft-канал) — по прецеденту
  UC2-4/W10: отдельный план-док + Playwright-стенд, свежей сессией. Быстрого
  безрискового среза не выделяется (Медиа в Studio-рейке уже есть — ST-3a).
- **ВОЛНА W11 ЗАКРЫТА ЦЕЛИКОМ (W11-1..W11-5).** W12 (честные режимы) закрыт
  2026-08-05 — программа аудита кабинета W7..W12 исполнена полностью.
