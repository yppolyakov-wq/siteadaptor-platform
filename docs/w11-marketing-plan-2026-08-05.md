...
- **W11-4 ✅** (2026-08-05): акция на услугу/номер/комбо из UI. PromotionForm
  ...
  test_w11_targets.
- **W11-5 — разведка ✅, код ОТЛОЖЕН свежей сессией** (2026-08-05): site.html —
...
- **ВОЛНА W11 в объёме хабов/лендинга/отзывов/акций ЗАКРЫТА (W11-1..W11-4);
  W11-5 — отложенный план-док.** Дальше: W12 (честные режимы, план §2.7).
