...
- **C. Свод per-page блоков save** в `home_builder_view` (только тождественные
  куски; presence-guard'ы остаются). Замки: test_home_builder (saves_*/presence-
  guards/preserves_page_layouts) — 1:1.
