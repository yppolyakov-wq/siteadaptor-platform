...
- ✅ **Богатая карточка услуги — фото** (`Service.image`, миграция `booking/0009`): миниатюра
  ...
  `test_services_section` (фото/регрессия). Дальше: профили мастеров (Resource staff + фото/био).
...
(A4 диет-иконки/фильтр — уже было ✅).
Осталось: A6 RV1 2-шаговый чекаут билета · RT1 QR-билет + check-in · RT3 recurring-серии · RT4 блог ·
A3 профили мастеров (Resource staff + фото/био) · A9 структурные данные авто (Kennzeichen/HSN-TSN).
Идём по убыванию
