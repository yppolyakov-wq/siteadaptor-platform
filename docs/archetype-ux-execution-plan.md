...
(A4 диет-иконки/фильтр меню — уже было ✅, см. F-A4).
Осталось: A6 RV1 2-шаговый чекаут билета · RT1 QR-билет + check-in · RT3 recurring-серии · RT4 блог ·
A3 богатая карточка услуги (миграция Service) + профили мастеров ·
A9 структурные данные авто (Kennzeichen/HSN-TSN) · A1/A2 отзывы о товаре (модель отзыва на Product).
Идём по убыванию
