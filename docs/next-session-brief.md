...
- **Дальше:** SE-1c (довести инспектор: колонки/число/источник/скрыть/переместить — финальная
  связка), затем SE-2 (редактор на каталоге/категории/событиях), SE-3 (микрошаблоны/шрифты/
  устройства + фон/отступы SE-3d), SE-4 (блоки/шаблоны), SE-5 (кэш+версии).
...
## Статус merge / deploy
- `main` сейчас: `ef1e4e4` (SE-1a/SE-1b/SE-1f/SE-3d + превью-фикс — всё слито, CI зелёный).
