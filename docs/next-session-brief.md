...
## Статус merge / deploy
- `main` сейчас: `8616bed`. Слито FF после зелёного CI: SE-2b-2, **SE-2c-1** (создание
  категории в редакторе), **SE-2c-2** (ссылка ✎ правки категории на канве), решение SE-2d
  (Вариант A), конвенция CLAUDE.md §5 «подготовка до кода». Ранее: SE-1a/1b/1c/1f/3d,
  SE-2a-1/2a-2/2a-3, SE-2b-1. Pending нет.
