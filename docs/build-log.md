...
**п.8 «нужны ли Reservierungen»** — анализ по всем архетипам в плане §«Анализ»,
решение за владельцем (вкладка появляется по правилу SM-2a «модуль = вкладка», а
у catering/hotel/tours/moto резервировать нечего: 0 акций типа «резерв»).
