...
меняет контролом «− N +», мобильный — две).
...
CSS. Добавлен в safelist вместе с `sm:grid-cols-4`; замок
`test_every_grid_class_the_layout_engine_emits_exists_in_the_built_css` сверяет
все комбинации таблиц движка с собранным CSS, чтобы следующий пресет не повторил
ошибку молча.
