...
5а. **Порядок после контент-хаба/быстрых побед (владелец, 2026-07-03: «Так и делай»):**
   **UE1+UE4-1** (промо-блок на канве главной + промо-шаблоны; план — `…-ue-plan` UE1-1..3, UE4-1)
   → **правовой-языковой пакет одним треком: L4 (.po/.mo хром) + L5 (LegalDoc) + E-2-остаток**
   (PAngV-ноты, AGB, засев права в 9 китов). U-D — после, свежей сессией с ревизией ud-плана.
