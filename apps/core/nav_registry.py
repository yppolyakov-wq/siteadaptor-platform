...
ENTRIES: tuple[NavEntry, ...] = (
    ...
    _e("marketing", "finder-settings", _("Finder"), "finder", None, True, "fragen empfehlung"),
    ...
    _e(
        ...
        _("Einstellungen"),
        "settings",
        search="kontakt öffnungszeiten firma",
    ),
    _e(
        "settings",
        "payment-settings",
        _("Zahlung & Versand"),
        "payments",
        search="stripe vorkasse lieferung zonen",
    ),
    _e(
        "settings",
    ...
    _e(
        ...
        _("Rechtstexte"),
        "legal-docs",
        search="impressum datenschutz agb widerruf",
    ),
    _e("settings", "extras", _("Zusatzleistungen"), "extras"),
    ...
    _e("settings", "billing", _("Abrechnung"), "billing", search="abo tarif subscription rechnung"),
