...
AMENITIES = [
    ...
    ("bath", _("Eigenes Bad"), "🛁"),
    ("shower", _("Dusche"), "🚿"),
    ("balcony", _("Balkon/Terrasse"), "🌅"),
    ("aircon", _("Klimaanlage"), "❄️"),
    ("kitchen", _("Küche/Kitchenette"), "🍳"),
    ("minibar", _("Minibar"), "🧊"),
    ("safe", _("Safe"), "🔒"),
    ("desk", _("Schreibtisch"), "🖥️"),
    ("coffee", _("Kaffee/Tee"), "☕"),
    ("hairdryer", _("Föhn"), "💨"),
    ("parking", _("Parkplatz"), "🅿️"),
    ("petfriendly", _("Haustiere erlaubt"), "🐾"),
    ("wheelchair", _("Barrierefrei"), "♿"),
    ("nonsmoking", _("Nichtraucher"), "🚭"),
]
...
class StayBooking(TimestampedModel):
    ...
    # B2.3: напоминание о незавершённой предоплате — дедуп «одно на бронь».
