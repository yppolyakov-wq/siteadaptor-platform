...
class DemoKit:
    ...
    # 2026-09-03 (волна online_shop): способы оплаты. Ни один кит их не задавал,
    # поэтому пикер оплаты (E7/SH-23) не показывался НИ В ОДНОМ демо — доступен
    # был только «Zahlung vor Ort». Онлайн-оплата остаётся за Stripe-Connect
    # (внешний блокер), а Vorkasse и счёт юрлицу демо показать может.
    #   {"vorkasse": True, "bank_holder": …, "bank_iban": …, "bank_bic": …,
    #    "invoice_b2b": True}
...
ONLINE_SHOP_MENUS = {
        ...
        "items": [
            {
                ...
                "target": "catalog",
                "children": [
                    {"label": "Mode & Basics", "type": "category", "target": "mode-basics"},
                    {"label": "Schuhe", "type": "category", "target": "schuhe"},
                    {
                        "label": "Taschen & Rucksäcke",
                        "type": "category",
                        "target": "taschen-rucksaecke",
                    },
                    {
                        "label": "Schmuck & Accessoires",
                        "type": "category",
                        "target": "schmuck-accessoires",
                    },
                    {"label": "Wohnen & Textil", "type": "category", "target": "wohnen-textil"},
                    {"label": "Küche & Tafel", "type": "category", "target": "kueche-tafel"},
                    {"label": "Kaffee & Tee", "type": "category", "target": "kaffee-tee"},
                    {"label": "Pflege & Bad", "type": "category", "target": "pflege-bad"},
                    {"label": "Papeterie & Büro", "type": "category", "target": "papeterie-buero"},
                    {"label": "Sport & Outdoor", "type": "category", "target": "sport-outdoor"},
                ],
            },
            {"label": "Sets", "type": "page", "target": "combos"},
            {"label": "Sale", "type": "archetype", "target": "promotions"},
            {
                "label": "Über uns",
                "type": "page",
                "target": "about",
    ...
    "bottom": {
        ...
        "items": [
            ...
            {"label": "Sale", "type": "archetype", "target": "promotions", "icon": "🏷️"},
            {"label": "Merkzettel", "type": "url", "target": "/merkzettel/", "icon": "❤️"},
            {"label": "Korb", "type": "archetype", "target": "orders", "icon": "🧺"},
        ],
    },
}
...
# 2026-09-03: dedicated-демо типа «Online-Shop». Тип делил витрину с фермерским
# магазином (DEMO_KIT_HOST["online_shop"] = "shop"), и на ней не было ни
# вариантов, ни комплектов, ни фильтров цвета/размера — то есть ровно того, чем
# интернет-магазин отличается от лавки. Кит показывает магазинные механики
# целиком: 10 направлений × 20 позиций, оси размер×цвет, Grundpreis по PAngV,
# наборы, подборки, способы оплаты и все виды акций.
ONLINE_SHOP = DemoKit(
    key="online_shop",
    label="Weitwerk",
    business_type="online_shop",
    subdomain="onlineshop",
    city="Düsseldorf",
    address="Ackerstraße 12, 40233 Düsseldorf",
    accent="#26303f",
    look="atelier",
    bundle="boutique",
    # Магазин с 200 позициями: оси вариантов кнопками+свотчами, листание фото на
    # карточке, широкий кадр — «кожа» сборки Boutique.
    variant_style="axes",
    card_slider="on",
    enable_categories_section=True,
    enable_finder=True,
    storefront_root="home",
    primary_module="catalog",
    seed_records=True,
    nav_style="minimal",
    menus=ONLINE_SHOP_MENUS,
    hero_image_kw="shop-atelier-regal",
    hero_title="Weitwerk",
    hero_text="Ausgesuchte Dinge für jeden Tag — Mode, Wohnen, Küche und "
    "Papeterie. Versand in 1–2 Werktagen, 30 Tage Rückgaberecht.",
    heroes=[
        {
            "image_kw": "shop-atelier-regal",
            "title": "Ausgesuchte Dinge für jeden Tag",
            "text": "Zehn Bereiche, ein Anspruch: gut gemacht, lange haltbar, ehrlich beschrieben.",
            "button_label": "Zum Sortiment",
            "button_url": "/sortiment/",
        },
        {
            "image_kw": "shop-atelier-mode",
            "title": "Neue Basics in fünf Größen",
            "text": "Shirts, Strick und Hemden aus Naturfasern — jetzt in drei neuen Farben.",
            "button_label": "Mode ansehen",
            "button_url": "/sortiment/mode-basics/",
        },
        {
            "image_kw": "shop-atelier-sale",
            "title": "Reduziert, solange Vorrat reicht",
            "text": "Einzelstücke und Vorjahresfarben — mit Preisnachlass, ohne Haken.",
            "button_label": "Zu den Angeboten",
            "button_url": "/aktionen/",
        },
    ],
    about_title="Über Weitwerk",
    about_text="Wir suchen Dinge, die man behalten will: Naturfasern statt Mischgewebe, "
    "Steinzeug statt Melamin, Ersatzteile statt Neukauf. Jedes Stück testen wir selbst, "
    "bevor es in den Shop kommt — und schreiben dazu, was es nicht kann.",
    opening_hours_text="Kundenservice Mo–Fr 9:00–17:00",
    opening_hours={d: ("09:00", "17:00") for d in range(5)},
    gallery_kw=[
        "shop-atelier-regal",
        "shop-atelier-mode",
        "shop-atelier-tisch",
        "shop-atelier-werkstatt",
        "shop-atelier-versand",
        "shop-atelier-detail",
    ],
    usp=[
        ("shipping", "Versand ab 3,90 € · ab 60 € frei"),
        ("returns", "30 Tage Rückgabe"),
        ("payment", "Rechnung, Vorkasse, Zahlung vor Ort"),
        ("bio", "Naturfasern & Nachfüllpackungen"),
    ],
    trust={
        "since": "2014",
        "marks": ["Versand aus Düsseldorf", "Ersatzteile nachkaufbar", "Klimaneutraler Versand"],
    },
    process=[
        ("Aussuchen", "Nach Größe, Farbe oder Bereich filtern."),
        ("Bestellen", "Rechnung, Vorkasse oder Zahlung bei Abholung."),
        ("Behalten", "Passt nicht? 30 Tage Rückgabe, Rücksendung kostenfrei."),
    ],
    # Портреты — из уже проверенного AI-набора (вымышленные лица): искать
    # портреты в CC0 нельзя, там реальные узнаваемые люди.
    team=[
        ("Marlene Kruse", "Einkauf & Sortiment", "fashion-designer"),
        ("Jonas Wender", "Versand & Service", "shop-assistant"),
    ],
    faq=[
        (
            "Wie lange dauert der Versand?",
            "Bestellungen bis 14 Uhr gehen am selben Werktag raus; innerhalb "
            "Deutschlands sind sie in der Regel nach 1–2 Werktagen da.",
        ),
        (
            "Was kostet die Rücksendung?",
            "Nichts. Sie bekommen mit der Bestellung ein Retourenlabel; "
            "30 Tage lang können Sie ungetragene Ware zurückschicken.",
        ),
        (
            "Welche Zahlungsarten gibt es?",
            "Kauf auf Rechnung für Firmen, Vorkasse per Überweisung und "
            "Zahlung bei Abholung in Düsseldorf.",
        ),
        (
            "Gibt es die Sachen auch zum Anfassen?",
            "Ja — unser Lager in der Ackerstraße ist mittwochs und freitags "
            "von 14 bis 18 Uhr offen, Abholung ist kostenlos.",
        ),
        (
            "Wie finde ich die richtige Größe?",
            "Bei Mode und Schuhen steht auf jeder Kategorieseite eine "
            "Größentabelle mit Körpermaßen, nicht mit Kleidungsmaßen.",
        ),
    ],
    testimonials=[
        (
            "Familie Osterloh",
            "Zweite Bestellung, wieder alles wie beschrieben. Die Wolldecke ist ihr Geld wert.",
        ),
        ("Ines B.", "Retoure war in zwei Tagen erledigt, Geld sofort zurück. So muss das."),
        ("Tarek A.", "Endlich ein Shop, der schreibt, was ein Teil NICHT kann."),
        ("Wiebke R.", "Die Größentabelle stimmt — das ist bei Online-Mode leider selten."),
    ],
    cta={
        "title": "Zehn Bereiche, ein Warenkorb",
        "text": "Mode, Wohnen, Küche, Papeterie — alles in einer Lieferung.",
        "button_label": "Zum Sortiment",
        "button_url": "/sortiment/",
    },
    enable_modules=["orders", "loyalty", "crm", "inbox", "blog"],
    delivery={
        "enabled": True,
        "fee_cents": 390,
        "free_cents": 6000,
        "min_cents": 0,
        "pickup_min_cents": 0,
        "area": "Deutschlandweit; Abholung in Düsseldorf",
        "zones": [
            {"plz": "40", "fee_cents": 290, "free_cents": 5000, "min_cents": 0},
            {"plz": "4", "fee_cents": 390, "free_cents": 6000, "min_cents": 0},
        ],
    },
    # 2026-09-03: первый кит со способами оплаты — пикер на чекауте показывает
    # Vorkasse и (фирме) счёт. Онлайн-оплата остаётся за Stripe-Connect.
    payments={
        "vorkasse": True,
        "bank_holder": "Weitwerk Handels GmbH",
        "bank_iban": "DE02 3005 0110 0000 1234 56",
        "bank_bic": "DUSSDEDDXXX",
        "invoice_b2b": True,
    },
    loyalty={"label": "Weitwerk-Punkte", "stamps": 8, "reward": "10 € Gutschein"},
    # Ряды плиток полные на всех ширинах (DL-11): 10 направлений — 5 колонок,
    # витрина новинок — 4, галерея — 3.
    section_layouts={
    ...
    size_tables={
        ...
        "S | 86–90 cm | 68–72 cm | 92–96 cm\n"
        "M | 90–96 cm | 72–78 cm | 96–102 cm\n"
        "L | 96–102 cm | 78–84 cm | 102–108 cm\n"
        "XL | 102–108 cm | 84–90 cm | 108–114 cm\n\n"
        "Alle Maße sind Körpermaße, nicht Kleidungsmaße. Zwischen zwei Größen "
        "empfehlen wir bei Strick die kleinere, bei Hemden die größere.",
        "schuhe": "Größe | Fußlänge\n36 | 22,8 cm\n37 | 23,5 cm\n38 | 24,1 cm\n"
        "39 | 24,8 cm\n40 | 25,4 cm\n41 | 26,1 cm\n42 | 26,7 cm\n43 | 27,4 cm\n"
        "44 | 28,0 cm\n45 | 28,7 cm\n46 | 29,4 cm\n\n"
        "Messen Sie abends im Stehen; die längere Länge zählt.",
        "wohnen-textil": "Decken | Maß\nPlaid | 130 × 170 cm\nSofadecke | 150 × 200 cm\n\n"
        "Kissenhüllen: 40 × 40 cm und 50 × 50 cm. Teppiche: 60 × 90 cm (Läufer), "
        "140 × 200 cm, 200 × 300 cm.",
    },
    categories=[
        (
            "Mode & Basics",
                ...
                (
                    ...
                    [
                        _p(
                            "Basic-Shirt „Halm“",
                            "39.00",
                            "Gerade geschnittenes T-Shirt aus schwerer Bio-Baumwolle mit 185 g/m², das nach der Wäsche seine Form behält. Die Schulternaht ist abgesteppt, der Halsausschnitt mit Ripp eingefasst. Das Halm ist unser meistverkauftes Shirt und die Grundlage der ganzen Kollektion. Der Stoff wird in Portugal gestrickt und vorgewaschen, damit er beim ersten Waschgang nicht mehr einläuft. Gerader Saum, nicht tailliert, Länge in Größe M 70 cm.",
                            ["shirt-halm-basic", "shirt-halm-detail", "shirt-halm-getragen"],
                            sku="MB-SHI-101",
                            gtin="4261001000001",
                            badge="beliebt",
                            material="100 % Bio-Baumwolle (kbA), 185 g/m²",
                            care="30 °C Buntwäsche, kein Trockner, bei mittlerer Temperatur bügeln.",
                            stock=72,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Creme",
                                    "stock": 3,
                                    "sku": "MB-SHI-101-XL-CR",
                                },
                                {
                                    "size": "XS",
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "MB-SHI-101-XS-SA",
                                },
                                {
                                    "size": "S",
                                    "color": "Sand",
                                ...
                                },
                                {
                                    ...
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "MB-SHI-101-XL-SA",
                                },
                                {
                                    "size": "XS",
                                    "color": "Anthrazit",
                                    "stock": 1,
                                    "sku": "MB-SHI-101-XS-AN",
                                },
                                {
                                    "size": "S",
                                    "color": "Anthrazit",
                                ...
                                },
                                {
                                    ...
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "MB-SHI-101-XL-AN",
                                },
                            ],
                        ),
                        _p(
                            "Ringel-Longsleeve „Ufer“",
                            "49.00",
                            "Langarmshirt mit schmalen Querstreifen und leicht verlängertem Rücken. Der Stoff ist etwas dichter als bei üblichen Ringelshirts und scheint auch bei hellen Streifen nicht durch.",
                            "shirt-ufer-streifen",
                            sku="MB-SHI-102",
                            gtin="4261002000008",
                            material="95 % Baumwolle, 5 % Elasthan, 210 g/m²",
                            care="30 °C Buntwäsche, kein Trockner, links bügeln.",
                            stock=38,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Nachtblau",
                                    "stock": 2,
                                    "sku": "MB-SHI-102-XL-NB",
                                },
                                {
                                    "size": "XS",
                                    "color": "Rostrot",
                                    "stock": 2,
                                    "sku": "MB-SHI-102-XS-RO",
                                },
                                {
                                    "size": "S",
                                    "color": "Rostrot",
                        ...
                        _p(
                            "Leinenhemd „Sund“",
                            "99.00",
                            "Hemd aus gewaschenem Leinen mit weichem Kragen und einer Brusttasche. Sitzt gerade, lässt sich offen über einem Shirt oder geschlossen tragen. Das Leinen kommt aus Belgien und wird nach dem Weben gewaschen, deshalb ist es vom ersten Tag an weich und knittert unregelmäßig statt scharfkantig. Knöpfe aus Steinnuss, Ärmel mit einfacher Manschette.",
                            ["hemd-sund-leinen", "hemd-sund-detail"],
                            sku="MB-HEM-103",
                            gtin="4261003000005",
                            badge="neu",
                            material="100 % Leinen, gewaschen, 165 g/m²",
                            care="30 °C Feinwäsche, kein Trockner, feucht bügeln.",
                            stock=35,
                            variants=[
                                {
                                    "size": "S",
                        ...
                        _p(
                            "Bluse „Falte“",
                            "89.00",
                            "Fließende Bluse aus Viskose mit einer Kellerfalte im Rücken und verdeckter Knopfleiste. Fällt weich, ohne aufzutragen, und lässt sich in den Bund stecken.",
                            "bluse-falte-viskose",
                            sku="MB-BLU-104",
                            gtin="4261004000002",
                            material="100 % Viskose (LENZING ECOVERO)",
                            care="30 °C Feinwäsche im Wäschenetz, nicht schleudern, kein Trockner.",
                            stock=34,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Creme",
                                    "stock": 2,
                                    "sku": "MB-BLU-104-XL-CR",
                                },
                                {
                                    "size": "XS",
                                    "color": "Nachtblau",
                                    "stock": 2,
                                    "sku": "MB-BLU-104-XS-NB",
                                },
                                {
                                    "size": "S",
                                    "color": "Nachtblau",
                        ...
                        _p(
                            "Polohemd „Deich“",
                            "69.00",
                            "Polohemd aus festem Piqué mit gestricktem Kragen, der auch nach vielen Wäschen nicht ausleiert. Zwei Knöpfe, Seitenschlitze am Saum.",
                            "polo-deich-pique",
                            sku="MB-POL-105",
                            gtin="4261005000009",
                            material="100 % Baumwolle, Piqué, 220 g/m²",
                            care="40 °C Buntwäsche, kein Trockner, Kragen feucht in Form ziehen.",
                            stock=30,
                            variants=[
                                {
                                    "size": "S",
                                ...
                                },
                                {
                                    ...
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "MB-POL-105-XL-SA",
                                },
                            ],
                        ),
                        _p(
                            "Rollkragenshirt „Nebel“",
                            "59.00",
                            "Feinripp-Shirt mit weichem Rollkragen, der doppelt gelegt getragen wird. Schmal geschnitten, damit es unter Pullover und Jacke nicht aufträgt.",
                            "shirt-nebel-rollkragen",
                            sku="MB-SHI-107",
                            gtin="4261007000003",
                            material="92 % Modal, 8 % Elasthan, Feinripp",
                            care="30 °C Feinwäsche, kein Trockner, nicht bügeln.",
                            stock=35,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Schwarz",
                                    "stock": 2,
                                    "sku": "MB-SHI-107-XL-SW",
                                },
                                {
                                    "size": "XS",
                                    "color": "Terrakotta",
                                    "stock": 1,
                                    "sku": "MB-SHI-107-XS-TE",
                                },
                                {
                                    "size": "S",
                                    "color": "Terrakotta",
                                ...
                                },
                                {
                                    ...
                                    "color": "Terrakotta",
                                    "stock": 1,
                                    "sku": "MB-SHI-107-XL-TE",
                                },
                            ],
                        ),
                    ],
                    "oberteile-stapel-baumwolle",
                ),
                (
                    "Strick & Sweat",
                    "strick-sweat",
                    [
                        _p(
                            "Sweatshirt „Werft“",
                            "89.00",
                            "Schweres Rundhals-Sweatshirt mit angerauter Innenseite und Zwickel am Halsausschnitt. Die Bündchen sind doppelt gestrickt und behalten die Spannung.",
                            "sweat-werft-rundhals",
                            sku="MB-SWE-106",
                            gtin="4261006000006",
                            material="80 % Bio-Baumwolle, 20 % recyceltes Polyester, 380 g/m²",
                            care="30 °C Buntwäsche, links waschen, kein Trockner.",
                            stock=47,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Grau meliert",
                                    "stock": 3,
                                    "sku": "MB-SWE-106-XL-GM",
                                },
                                {
                                    "size": "XS",
                                    "color": "Salbei",
                                    "stock": 2,
                                    "sku": "MB-SWE-106-XS-SB",
                                },
                                {
                                    "size": "S",
                                    "color": "Salbei",
                        ...
                        _p(
                            "Wollpullover „Kliff“",
                            "149.00",
                            "Klassischer Rundhalspullover aus feiner Schurwolle, mittelschwer gestrickt und dadurch das ganze Jahr über tragbar. Raglanärmel geben Bewegungsfreiheit an der Schulter. Die Wolle stammt aus mulesingfreier Haltung und wird in Norditalien gesponnen. Der Strick ist mit 12 Nadeln fein genug, um unter einer Jacke getragen zu werden, und trotzdem dicht genug für kalte Tage. Bündchen und Halsausschnitt sind doppelt gelegt.",
                            [
                                "pullover-kliff-wolle",
                                "pullover-kliff-detail",
                                "pullover-kliff-getragen",
                            ],
                            sku="MB-PUL-108",
                            gtin="4261008000000",
                            material="100 % Schurwolle (mulesingfrei), 12 gg",
                            care="Wollwaschgang 30 °C oder Handwäsche, liegend trocknen, nicht schleudern.",
                            stock=45,
                            variants=[
                                {
                                    "size": "S",
                                ...
                                },
                                {
                                    ...
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "MB-PUL-108-XL-AN",
                                },
                            ],
                        ),
                        _p(
                            "Grobstrick-Cardigan „Moor“",
                            "139.00",
                            "Offene Strickjacke aus grober Wollmischung mit zwei aufgesetzten Taschen und tief angesetzter Schulter. Reicht bis knapp über die Hüfte.",
                            "cardigan-moor-grobstrick",
                            sku="MB-CAR-109",
                            gtin="4261009000007",
                            material="70 % Schurwolle, 30 % Alpaka, 5 gg",
                            care="Handwäsche kalt, liegend trocknen, Fusseln mit dem Kamm entfernen.",
                            stock=28,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "MB-CAR-109-XL-SA",
                                },
                                {
                                    "size": "XS",
                                    "color": "Anthrazit",
                                    "stock": 1,
                                    "sku": "MB-CAR-109-XS-AN",
                                },
                                {
                                    "size": "S",
                                    "color": "Anthrazit",
                                ...
                                },
                                {
                                    ...
                                    "color": "Anthrazit",
                                    "stock": 1,
                                    "sku": "MB-CAR-109-XL-AN",
                                },
                            ],
                        ),
                        _p(
                            "Feinstrick-Pullover „Dünung“",
                            "99.00",
                            "Leichter Pullover aus Baumwoll-Feinstrick mit V-Ausschnitt, der auch über einem Hemd getragen werden kann. Gerade geschnitten mit schmalen Bündchen.",
                            "pullover-duenung-feinstrick",
                            sku="MB-PUL-110",
                            gtin="4261010000004",
                            material="100 % Baumwolle, 14 gg Feinstrick",
                            care="30 °C Feinwäsche, liegend trocknen, bei niedriger Temperatur bügeln.",
                            stock=35,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Salbei",
                                    "stock": 2,
                                    "sku": "MB-PUL-110-XL-SB",
                                },
                                {
                                    "size": "XS",
                                    "color": "Creme",
                                    "stock": 2,
                                    "sku": "MB-PUL-110-XS-CR",
                                },
                                {
                                    "size": "S",
                                    "color": "Creme",
                                ...
                                },
                                {
                                    ...
                                    "color": "Creme",
                                    "stock": 2,
                                    "sku": "MB-PUL-110-XL-CR",
                                },
                            ],
                        ),
                        _p(
                            "Kapuzenpullover „Hafen“",
                            "109.00",
                            "Hoodie aus schwerem Loopback-Sweat mit doppellagiger Kapuze und flacher Kordel. Die Kängurutasche ist an den Seiten geschlossen eingenäht.",
                            "hoodie-hafen-kapuze",
                            sku="MB-HOO-111",
                            gtin="4261011000001",
                            material="100 % Bio-Baumwolle, Loopback, 420 g/m²",
                            care="30 °C Buntwäsche, links waschen, kein Trockner, Kordel vor der Wäsche knoten.",
                            stock=33,
                            variants=[
                                {
                                    "size": "S",
                                ...
                                },
                                {
                                    ...
                                    "color": "Rostrot",
                                    "stock": 1,
                                    "sku": "MB-HOO-111-XL-RO",
                                },
                            ],
                        ),
                        _p(
                            "Zopfstrick-Pullover „Reet“",
                            "139.00",
                            "Handgeführter Zopfstrick aus dicker Wolle, wie er an der Küste seit Generationen getragen wird. Schwer, warm und mit hohem Kragen. Nur noch wenige Stück verfügbar.",
                            "pullover-reet-zopf",
                            sku="MB-PUL-112",
                            gtin="4261012000008",
                            material="100 % Schurwolle, 3 gg Zopfstrick",
                            care="Nur Handwäsche kalt, liegend trocknen, nicht wringen.",
                            stock=3,
                            variants=[
                                {
                                    "size": "S",
                ...
                (
                    ...
                    [
                        _p(
                            "Chino „Anker“",
                            "99.00",
                            "Gerade geschnittene Chino aus festem Baumwolltwill mit Seitentaschen und zwei Gesäßtaschen mit Riegel. Innenbeinlänge 82 cm, ungesäumt lieferbar.",
                            "hose-anker-chino",
                            sku="MB-HOS-113",
                            gtin="4261013000005",
                            material="98 % Baumwolle, 2 % Elasthan, Twill 290 g/m²",
                            care="40 °C Buntwäsche, links waschen, Trockner niedrig, bügeln bei mittlerer Stufe.",
                            stock=28,
                            variants=[
                                {
                                    "size": "W30",
                                    "color": "Sand",
                                    "stock": 3,
                                    "sku": "MB-HOS-113-W30-SA",
                                },
                                {
                                    "size": "W32",
                                    "color": "Sand",
                                    "stock": 6,
                                    "sku": "MB-HOS-113-W32-SA",
                                },
                                {
                                    "size": "W34",
                                    "color": "Sand",
                                    "stock": 4,
                                    "sku": "MB-HOS-113-W34-SA",
                                },
                                {
                                    "size": "W36",
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "MB-HOS-113-W36-SA",
                                },
                                {
                                    "size": "W30",
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "MB-HOS-113-W30-AN",
                                },
                                {
                                    "size": "W32",
                                    "color": "Anthrazit",
                                    "stock": 5,
                                    "sku": "MB-HOS-113-W32-AN",
                                },
                                {
                                    "size": "W34",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "MB-HOS-113-W34-AN",
                                },
                                {
                                    "size": "W36",
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "MB-HOS-113-W36-AN",
                                },
                            ],
                        ),
                        _p(
                            "Jeans „Ebbe“",
                            "119.00",
                            "Fünf-Pocket-Jeans mit geradem Bein und mittelhohem Bund aus festem, nur leicht elastischem Denim. Nieten und Knopf sind dunkel vernickelt. Der Denim wird in Italien gewebt und wiegt 13,5 oz, das ist deutlich fester als die üblichen Stretchjeans. Er formt sich nach etwa zwei Wochen dem Körper an. Beinlänge 84 cm, für kleinere Größen zum Umschlagen gedacht.",
                            ["hose-ebbe-jeans", "hose-ebbe-detail"],
                            sku="MB-HOS-114",
                            gtin="4261014000002",
                            material="99 % Baumwolle, 1 % Elasthan, Denim 13,5 oz",
                            care="Selten und auf links bei 30 °C waschen, kein Trockner, an der Luft trocknen.",
                            stock=36,
                            variants=[
                                {
                                    "size": "W30",
                                    "color": "Nachtblau",
                                    "stock": 4,
                                    "sku": "MB-HOS-114-W30-NB",
                                },
                                {
                                    "size": "W32",
                                    "color": "Nachtblau",
                                    "stock": 8,
                                    "sku": "MB-HOS-114-W32-NB",
                                },
                                {
                                    "size": "W34",
                                    "color": "Nachtblau",
                                    "stock": 6,
                                    "sku": "MB-HOS-114-W34-NB",
                                },
                                {
                                    "size": "W36",
                                    "color": "Nachtblau",
                                    "stock": 3,
                                    "sku": "MB-HOS-114-W36-NB",
                                },
                                {
                                    "size": "W30",
                                    "color": "Schwarz",
                                    "stock": 3,
                                    "sku": "MB-HOS-114-W30-SW",
                                },
                                {
                                    "size": "W32",
                                    "color": "Schwarz",
                                    "stock": 6,
                                    "sku": "MB-HOS-114-W32-SW",
                                },
                                {
                                    "size": "W34",
                                    "color": "Schwarz",
                                    "stock": 4,
                                    "sku": "MB-HOS-114-W34-SW",
                                },
                                {
                                    "size": "W36",
                                    "color": "Schwarz",
                                    "stock": 2,
                                    "sku": "MB-HOS-114-W36-SW",
                                },
                            ],
                        ),
                        _p(
                            "Cordhose „Kies“",
                            "99.00",
                            "Hose aus mittelbreitem Babycord mit leicht konischem Bein und hohem Bund. Der Cord ist vorgewaschen und deshalb von Anfang an weich.",
                            "hose-kies-cord",
                            sku="MB-HOS-115",
                            gtin="4261015000009",
                            material="97 % Baumwolle, 3 % Elasthan, Babycord 320 g/m²",
                            care="30 °C links waschen, kein Trockner, im Cordstrich glatt ziehen.",
                            stock=18,
                            variants=[
                                {
                                    "size": "W30",
                                    "color": "Terrakotta",
                                    "stock": 2,
                                    "sku": "MB-HOS-115-W30-TE",
                                },
                                {
                                    "size": "W32",
                                    "color": "Terrakotta",
                                    "stock": 4,
                                    "sku": "MB-HOS-115-W32-TE",
                                },
                                {
                                    "size": "W34",
                                    "color": "Terrakotta",
                                    "stock": 3,
                                    "sku": "MB-HOS-115-W34-TE",
                                },
                                {
                                    "size": "W30",
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "MB-HOS-115-W30-AN",
                                },
                                {
                                    "size": "W32",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "MB-HOS-115-W32-AN",
                                },
                                {
                                    "size": "W34",
                                    "color": "Anthrazit",
                                    "stock": 3,
                                    "sku": "MB-HOS-115-W34-AN",
                                },
                            ],
                        ),
                        _p(
                            "Jerseykleid „Welle“",
                            "109.00",
                            "Knielanges Kleid aus schwerem Jersey mit Rundhals und angeschnittenen Ärmeln. Fällt gerade und knittert auch nach einem langen Tag kaum.",
                            "kleid-welle-jersey",
                            sku="MB-KLD-116",
                            gtin="4261016000006",
                            material="95 % Modal, 5 % Elasthan, 260 g/m²",
                            care="30 °C Feinwäsche, kein Trockner, bei Bedarf mit Dampf glätten.",
                            stock=37,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Schwarz",
                                    "stock": 2,
                                    "sku": "MB-KLD-116-XL-SW",
                                },
                                {
                                    "size": "XS",
                                    "color": "Nachtblau",
                                    "stock": 2,
                                    "sku": "MB-KLD-116-XS-NB",
                                },
                                {
                                    "size": "S",
                                    "color": "Nachtblau",
                        ...
                        _p(
                            "Leinenkleid „Ried“",
                            "119.00",
                            "Weites Sommerkleid aus gewaschenem Leinen mit Knopfleiste bis zur Taille und aufgesetzten Taschen. Wadenlang, mit Bindegürtel zum Herausnehmen. Das Kleid entsteht aus demselben belgischen Leinen wie unser Hemd Sund, nur in einer leichteren Qualität. Es fällt bewusst weit, damit es an heißen Tagen nicht anliegt. Länge in Größe M 118 cm ab Schulter.",
                            ["kleid-ried-leinen", "kleid-ried-getragen"],
                            sku="MB-KLD-117",
                            gtin="4261017000003",
                            material="100 % Leinen, gewaschen, 150 g/m²",
                            care="30 °C Feinwäsche, kein Trockner, feucht bügeln oder bewusst knittrig tragen.",
                            stock=0,
                            variants=[
                                {
                                    "size": "XS",
                                ...
                                },
                                {
                                    ...
                                    "color": "Creme",
                                    "stock": 0,
                                    "sku": "MB-KLD-117-XL-CR",
                                },
                                {
                                    "size": "XS",
                                    "color": "Terrakotta",
                                    "stock": 0,
                                    "sku": "MB-KLD-117-XS-TE",
                                },
                                {
                                    "size": "S",
                                    "color": "Terrakotta",
                                ...
                                },
                                {
                                    ...
                                    "color": "Terrakotta",
                                    "stock": 0,
                                    "sku": "MB-KLD-117-XL-TE",
                                },
                            ],
                        ),
                    ],
                    "hosen-kleider-buegel",
                ),
                (
                    "Jacken & Westen",
                    "jacken-westen",
                    [
                        _p(
                            "Jeansjacke „Steg“",
                            "139.00",
                            "Kurze Jeansjacke mit Brusttaschen, Metallknöpfen und verstellbaren Riegeln am Saum. Der Denim ist ungewaschen und wird mit der Zeit heller.",
                            ["jacke-steg-denim", "jacke-steg-detail"],
                            sku="MB-JAC-118",
                            gtin="4261018000000",
                            material="100 % Baumwolle, Denim 12 oz",
                            care="30 °C separat waschen (färbt anfangs ab), kein Trockner.",
                            stock=27,
                            variants=[
                                {
                                    "size": "S",
                        ...
                        _p(
                            "Steppweste „Warft“",
                            "129.00",
                            "Leichte Steppweste mit Stehkragen und zwei Reißverschlusstaschen, dünn genug für unter die Jacke. Die Füllung besteht aus recyceltem Polyester.",
                            "weste-warft-stepp",
                            sku="MB-WES-119",
                            gtin="4261019000007",
                            material="Außen 100 % recyceltes Polyamid, Füllung 100 % recyceltes Polyester",
                            care="30 °C Feinwäsche, Trockner niedrig mit zwei Tennisbällen, nicht bügeln.",
                            stock=29,
                            variants=[
                                {
                                    "size": "S",
                                ...
                                },
                                {
                                    ...
                                    "color": "Salbei",
                                    "stock": 1,
                                    "sku": "MB-WES-119-XL-SB",
                                },
                            ],
                        ),
                        _p(
                            "Übergangsmantel „Nordlicht“",
                            "249.00",
                            "Unwattierter Mantel im Trenchschnitt aus dicht gewebter Baumwolle, wasserabweisend ausgerüstet. Knielang, mit Sturmpatte und abnehmbarem Gürtel. Letzte Stücke der Saison.",
                            "mantel-nordlicht-trench",
                            sku="MB-MAN-120",
                            gtin="4261020000004",
                            material="100 % Baumwolle, Gabardine, wasserabweisend ausgerüstet (PFC-frei)",
                            care="Nur Reinigung, nicht waschen, Imprägnierung nach der Reinigung erneuern.",
                            stock=4,
                            variants=[
                                {
                                    "size": "S",
                                ...
                                },
                                {
                                    ...
                                    "color": "Sand",
                                    "stock": 1,
                                    "sku": "MB-MAN-120-XL-SA",
                                },
                            ],
                        ),
                    ],
                    "jacken-westen-garderobe",
                ),
            ],
            "Ruhige Basics für jeden Tag: Oberteile, Strick, Hosen und Jacken aus Naturfasern. Alle Teile in den Größen XS bis XL und in aufeinander abgestimmten Farben, damit sich Neues mit Vorhandenem kombinieren lässt.",
            "",
            "mode-basics-uebersicht",
        ),
        (
            "Schuhe",
            "schuhe",
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Leder-Sneaker „Kiesel“",
                            "139.00",
                            "Glatter Rindsleder-Sneaker mit schmaler Gummisohle und herausnehmbarem Fußbett. Sitzt vom ersten Tag an, ohne Einlaufzeit.",
                            ["sneaker-kiesel", "kiesel-sohle", "kiesel-strasse"],
                            sku="SCH-SNK-001",
                            gtin="4260410000017",
                            badge="beliebt",
                            material="Obermaterial Rindsleder (glatt), Futter Ziegenleder, Laufsohle Naturkautschuk",
                            care="Mit feuchtem Tuch abwischen, gelegentlich farblose Schuhcreme auftragen. Nicht in die Waschmaschine, nicht auf der Heizung trocknen.",
                            stock=68,
                            variants=[
                                {
                                    "size": "40",
                                    "color": "Weiß",
                                    "stock": 6,
                                    "sku": "SCH-SNK-001-40-WEI",
                                },
                                {
                                    "size": "41",
                                    "color": "Weiß",
                                    "stock": 9,
                                    "sku": "SCH-SNK-001-41-WEI",
                                },
                                {
                                    "size": "42",
                                    "color": "Weiß",
                                    "stock": 11,
                                    "sku": "SCH-SNK-001-42-WEI",
                                },
                                {
                                    "size": "43",
                                    "color": "Weiß",
                                    "stock": 8,
                                    "sku": "SCH-SNK-001-43-WEI",
                                },
                                {
                                    "size": "44",
                                    "color": "Weiß",
                                    "stock": 4,
                                    "sku": "SCH-SNK-001-44-WEI",
                                },
                                {
                                    "size": "40",
                                    "color": "Anthrazit",
                                    "stock": 5,
                                    "sku": "SCH-SNK-001-40-ANT",
                                },
                                {
                                    "size": "41",
                                    "color": "Anthrazit",
                                    "stock": 7,
                                    "sku": "SCH-SNK-001-41-ANT",
                                },
                                {
                                    "size": "42",
                                    "color": "Anthrazit",
                                    "stock": 9,
                                    "sku": "SCH-SNK-001-42-ANT",
                                },
                                {
                                    "size": "43",
                                    "color": "Anthrazit",
                                    "stock": 6,
                                    "sku": "SCH-SNK-001-43-ANT",
                                },
                                {
                                    "size": "44",
                                    "color": "Anthrazit",
                                    "stock": 3,
                                    "sku": "SCH-SNK-001-44-ANT",
                                },
                            ],
                        ),
                        _p(
                            "Canvas-Sneaker „Deich“",
                            "79.00",
                            "Leichter Sommerschuh aus festem Baumwoll-Canvas mit vulkanisierter Sohle. Läuft sich weich und lässt sich bei 30 Grad im Wäschenetz waschen.",
                            "sneaker-deich",
                            sku="SCH-SNK-002",
                            gtin="4260410000024",
                            material="Obermaterial 100 % Baumwoll-Canvas, Laufsohle Gummi, Innensohle Textil",
                            care="Bei 30 Grad im Wäschenetz waschen, an der Luft trocknen. Keinen Trockner, keine Bleiche.",
                            stock=45,
                            variants=[
                                {
                                    "size": "39",
                                    "color": "Sand",
                                    "stock": 4,
                                    "sku": "SCH-SNK-002-39-SAN",
                                },
                                {
                                    "size": "40",
                                    "color": "Sand",
                                    "stock": 6,
                                    "sku": "SCH-SNK-002-40-SAN",
                                },
                                {
                                    "size": "41",
                                    "color": "Sand",
                                    "stock": 7,
                                    "sku": "SCH-SNK-002-41-SAN",
                                },
                                {
                                    "size": "42",
                                    "color": "Sand",
                                    "stock": 5,
                                    "sku": "SCH-SNK-002-42-SAN",
                                },
                                {
                                    "size": "43",
                                    "color": "Sand",
                                    "stock": 3,
                                    "sku": "SCH-SNK-002-43-SAN",
                                },
                                {
                                    "size": "39",
                                    "color": "Nachtblau",
                                    "stock": 3,
                                    "sku": "SCH-SNK-002-39-NAV",
                                },
                                {
                                    "size": "40",
                                    "color": "Nachtblau",
                                    "stock": 5,
                                    "sku": "SCH-SNK-002-40-NAV",
                                },
                                {
                                    "size": "41",
                                    "color": "Nachtblau",
                                    "stock": 6,
                                    "sku": "SCH-SNK-002-41-NAV",
                                },
                                {
                                    "size": "42",
                                    "color": "Nachtblau",
                                    "stock": 4,
                                    "sku": "SCH-SNK-002-42-NAV",
                                },
                                {
                                    "size": "43",
                                    "color": "Nachtblau",
                                    "stock": 2,
                                    "sku": "SCH-SNK-002-43-NAV",
                                },
                            ],
                        ),
                        _p(
                            "Wildleder-Sneaker „Moos“",
                            "129.00",
                            "Sneaker aus geöltem Veloursleder mit gepolstertem Einstieg und flacher Profilsohle. Die Farbe wird mit der Zeit etwas heller.",
                            "sneaker-moos",
                            sku="SCH-SNK-003",
                            gtin="4260410000031",
                            material="Obermaterial Veloursleder (Rind), Futter Textil, Laufsohle Gummi",
                            care="Mit Wildlederbürste aufrauen, vor dem ersten Tragen imprägnieren. Flecken trocken ausbürsten, nicht nass reinigen.",
                            stock=31,
                            variants=[
                                {
                                    "size": "39",
                                    "color": "Salbei",
                                    "stock": 3,
                                    "sku": "SCH-SNK-003-39-SAL",
                                },
                                {
                                    "size": "40",
                                    "color": "Salbei",
                                    "stock": 5,
                                    "sku": "SCH-SNK-003-40-SAL",
                                },
                                {
                                    "size": "41",
                                    "color": "Salbei",
                                    "stock": 6,
                                    "sku": "SCH-SNK-003-41-SAL",
                                },
                                {
                                    "size": "42",
                                    "color": "Salbei",
                                    "stock": 7,
                                    "sku": "SCH-SNK-003-42-SAL",
                                },
                                {
                                    "size": "43",
                                    "color": "Salbei",
                                    "stock": 5,
                                    "sku": "SCH-SNK-003-43-SAL",
                                },
                                {
                                    "size": "44",
                                    "color": "Salbei",
                                    "stock": 3,
                                    "sku": "SCH-SNK-003-44-SAL",
                                },
                                {
                                    "size": "45",
                                    "color": "Salbei",
                                    "stock": 2,
                                    "sku": "SCH-SNK-003-45-SAL",
                                },
                            ],
                        ),
                        _p(
                            "Laufschuh „Windbö“",
                            "149.00",
                            "Dämpfender Straßenlaufschuh für Distanzen bis 15 Kilometer, Sprengung 8 Millimeter. Das Obermaterial aus Recycling-Mesh trocknet nach dem Regen schnell.",
                            ["laufschuh-windboe", "windboe-strecke"],
                            sku="SCH-SNK-004",
                            gtin="4260410000048",
                            material="Obermaterial Recycling-Polyester-Mesh, Zwischensohle EVA-Schaum, Laufsohle Gummi",
                            care="Nur mit lauwarmem Wasser und weicher Bürste reinigen, Einlegesohle separat trocknen. Nicht in Waschmaschine oder Trockner.",
                            stock=52,
                            variants=[
                                {
                                    "size": "40",
                                    "color": "Anthrazit",
                                    "stock": 5,
                                    "sku": "SCH-SNK-004-40-ANT",
                                },
                                {
                                    "size": "41",
                                    "color": "Anthrazit",
                                    "stock": 8,
                                    "sku": "SCH-SNK-004-41-ANT",
                                },
                                {
                                    "size": "42",
                                    "color": "Anthrazit",
                                    "stock": 9,
                                    "sku": "SCH-SNK-004-42-ANT",
                                },
                                {
                                    "size": "43",
                                    "color": "Anthrazit",
                                    "stock": 6,
                                    "sku": "SCH-SNK-004-43-ANT",
                                },
                                {
                                    "size": "44",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "SCH-SNK-004-44-ANT",
                                },
                                {
                                    "size": "40",
                                    "color": "Rostrot",
                                    "stock": 3,
                                    "sku": "SCH-SNK-004-40-ROS",
                                },
                                {
                                    "size": "41",
                                    "color": "Rostrot",
                                    "stock": 5,
                                    "sku": "SCH-SNK-004-41-ROS",
                                },
                                {
                                    "size": "42",
                                    "color": "Rostrot",
                                    "stock": 6,
                                    "sku": "SCH-SNK-004-42-ROS",
                                },
                                {
                                    "size": "43",
                                    "color": "Rostrot",
                                    "stock": 4,
                                    "sku": "SCH-SNK-004-43-ROS",
                                },
                                {
                                    "size": "44",
                                    "color": "Rostrot",
                                    "stock": 2,
                                    "sku": "SCH-SNK-004-44-ROS",
                                },
                            ],
                        ),
                        _p(
                            "Retro-Sneaker „Bahnsteig“",
                            "109.00",
                            "Flacher Trainer im Schnitt der Siebzigerjahre, Obermaterial aus Nubuk und Nylon. Schmale Passform, im Zweifel eine halbe Nummer größer wählen.",
                            "sneaker-bahnsteig",
                            sku="SCH-SNK-005",
                            gtin="4260410000055",
                            material="Obermaterial Nubukleder und Nylon, Futter Textil, Laufsohle Gummi",
                            care="Trocken ausbürsten, Nubukstellen mit Krepprubber auffrischen. Bei Nässe mit Zeitungspapier ausstopfen und langsam trocknen.",
                            stock=27,
                            variants=[
                                {
                                    "size": "38",
                                    "color": "Creme",
                                    "stock": 2,
                                    "sku": "SCH-SNK-005-38-CRE",
                                },
                                {
                                    "size": "39",
                                    "color": "Creme",
                                    "stock": 3,
                                    "sku": "SCH-SNK-005-39-CRE",
                                },
                                {
                                    "size": "40",
                                    "color": "Creme",
                                    "stock": 4,
                                    "sku": "SCH-SNK-005-40-CRE",
                                },
                                {
                                    "size": "41",
                                    "color": "Creme",
                                    "stock": 5,
                                    "sku": "SCH-SNK-005-41-CRE",
                                },
                                {
                                    "size": "42",
                                    "color": "Creme",
                                    "stock": 4,
                                    "sku": "SCH-SNK-005-42-CRE",
                                },
                                {
                                    "size": "43",
                                    "color": "Creme",
                                    "stock": 4,
                                    "sku": "SCH-SNK-005-43-CRE",
                                },
                                {
                                    "size": "44",
                                    "color": "Creme",
                                    "stock": 3,
                                    "sku": "SCH-SNK-005-44-CRE",
                                },
                                {
                                    "size": "45",
                                    "color": "Creme",
                                    "stock": 2,
                                    "sku": "SCH-SNK-005-45-CRE",
                                },
                            ],
                        ),
                        _p(
                            "Trail-Schuh „Geröll“",
                            "159.00",
                            "Halbhoher Schuh für Schotter und Waldboden, 4 Millimeter Stollen und geschützte Zehenkappe. Die Membran hält von außen dicht und lässt Schweiß nach draußen.",
                            "trailschuh-geroell",
                            sku="SCH-SNK-006",
                            gtin="4260410000062",
                            badge="neu",
                            material="Obermaterial Ripstop-Gewebe mit Wassermembran, Zwischensohle EVA, Laufsohle Profilgummi",
                            care="Nach der Tour Erde ausbürsten und mit klarem Wasser abspülen. Membran regelmäßig nachimprägnieren, nicht im Trockner behandeln.",
                            stock=36,
                            variants=[
                                {
                                    "size": "40",
                                    "color": "Terrakotta",
                                    "stock": 4,
                                    "sku": "SCH-SNK-006-40-TER",
                                },
                                {
                                    "size": "41",
                                    "color": "Terrakotta",
                                    "stock": 5,
                                    "sku": "SCH-SNK-006-41-TER",
                                },
                                {
                                    "size": "42",
                                    "color": "Terrakotta",
                                    "stock": 6,
                                    "sku": "SCH-SNK-006-42-TER",
                                },
                                {
                                    "size": "43",
                                    "color": "Terrakotta",
                                    "stock": 4,
                                    "sku": "SCH-SNK-006-43-TER",
                                },
                                {
                                    "size": "44",
                                    "color": "Terrakotta",
                                    "stock": 2,
                                    "sku": "SCH-SNK-006-44-TER",
                                },
                                {
                                    "size": "40",
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "SCH-SNK-006-40-ANT",
                                },
                                {
                                    "size": "41",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "SCH-SNK-006-41-ANT",
                                },
                                {
                                    "size": "42",
                                    "color": "Anthrazit",
                                    "stock": 5,
                                    "sku": "SCH-SNK-006-42-ANT",
                                },
                                {
                                    "size": "43",
                                    "color": "Anthrazit",
                                    "stock": 3,
                                    "sku": "SCH-SNK-006-43-ANT",
                                },
                                {
                                    "size": "44",
                                    "color": "Anthrazit",
                                    "stock": 1,
                                    "sku": "SCH-SNK-006-44-ANT",
                                },
                            ],
                        ),
                    ],
                ...
                (
                    ...
                    [
                        _p(
                            "Chelsea-Boot „Torf“",
                            "189.00",
                            "Klassischer Schlupfstiefel aus pflanzlich gegerbtem Rindsleder mit elastischen Seiteneinsätzen. Die Ledersohle ist rahmengenäht und lässt sich neu besohlen.",
                            ["chelsea-torf", "torf-schaft"],
                            sku="SCH-BOO-001",
                            gtin="4260410000079",
                            material="Obermaterial pflanzlich gegerbtes Rindsleder, Futter Leder, Sohle Leder mit Gummiabsatz",
                            care="Regelmäßig mit Lederfett oder Schuhcreme nähren, Schuhspanner einsetzen. Nasses Leder langsam bei Zimmertemperatur trocknen.",
                            stock=45,
                            variants=[
                                {
                                    "size": "39",
                                    ...
                                    "stock": 3,
                                    "sku": "SCH-BOO-001-39-KAS",
                                },
                                {
                                    "size": "40",
                                    "color": "Kastanienbraun",
                                    "stock": 5,
                                    "sku": "SCH-BOO-001-40-KAS",
                                },
                                {
                                    "size": "41",
                                    "color": "Kastanienbraun",
                                    "stock": 7,
                                    "sku": "SCH-BOO-001-41-KAS",
                                },
                                {
                                    "size": "42",
                                    "color": "Kastanienbraun",
                                    "stock": 6,
                                    "sku": "SCH-BOO-001-42-KAS",
                                },
                                {
                                    "size": "43",
                                    "color": "Kastanienbraun",
                                    "stock": 4,
                                    "sku": "SCH-BOO-001-43-KAS",
                                },
                                {
                                    "size": "44",
                                    "color": "Kastanienbraun",
                                    "stock": 2,
                                    "sku": "SCH-BOO-001-44-KAS",
                                },
                                {
                                    "size": "39",
                                    "color": "Schwarz",
                                    "stock": 2,
                                    "sku": "SCH-BOO-001-39-SCW",
                                },
                                {
                                    "size": "40",
                                    "color": "Schwarz",
                                    "stock": 3,
                                    "sku": "SCH-BOO-001-40-SCW",
                                },
                                {
                                    "size": "41",
                                    "color": "Schwarz",
                                    "stock": 5,
                                    "sku": "SCH-BOO-001-41-SCW",
                                },
                                {
                                    "size": "42",
                                    "color": "Schwarz",
                                    "stock": 4,
                                    "sku": "SCH-BOO-001-42-SCW",
                                },
                                {
                                    "size": "43",
                                    "color": "Schwarz",
                                    "stock": 3,
                                    "sku": "SCH-BOO-001-43-SCW",
                                },
                                {
                                    "size": "44",
                                    "color": "Schwarz",
                                    "stock": 1,
                                    "sku": "SCH-BOO-001-44-SCW",
                                },
                            ],
                        ),
                        _p(
                            "Schnürstiefel „Fährmann“",
                            "219.00",
                            "Hoher Schnürstiefel mit acht Ösenpaaren, gefettetem Leder und griffiger Gummisohle. Gedacht für Herbstwege, nicht für den Bauhof.",
                            "stiefel-faehrmann",
                            sku="SCH-BOO-002",
                            gtin="4260410000086",
                            material="Obermaterial gefettetes Rindsleder, Futter Leder, Laufsohle Gummi mit Profil",
                            care="Alle paar Wochen mit Lederfett einreiben, Nähte besonders beachten. Nicht direkt an der Heizung trocknen.",
                            stock=22,
                            variants=[
                                {
                                    "size": "40",
                                    "color": "Dunkelbraun",
                                    "stock": 2,
                                    "sku": "SCH-BOO-002-40-DBR",
                                },
                                {
                                    "size": "41",
                                    "color": "Dunkelbraun",
                                    "stock": 3,
                                    "sku": "SCH-BOO-002-41-DBR",
                                },
                                {
                                    "size": "42",
                                    "color": "Dunkelbraun",
                                    "stock": 4,
                                    "sku": "SCH-BOO-002-42-DBR",
                                },
                                {
                                    "size": "43",
                                    "color": "Dunkelbraun",
                                    "stock": 5,
                                    "sku": "SCH-BOO-002-43-DBR",
                                },
                                {
                                    "size": "44",
                                    "color": "Dunkelbraun",
                                    "stock": 4,
                                    "sku": "SCH-BOO-002-44-DBR",
                                },
                                {
                                    "size": "45",
                                    "color": "Dunkelbraun",
                                    "stock": 3,
                                    "sku": "SCH-BOO-002-45-DBR",
                                },
                                {
                                    "size": "46",
                                    "color": "Dunkelbraun",
                                    "stock": 1,
                                    "sku": "SCH-BOO-002-46-DBR",
                                },
                            ],
                        ),
                        _p(
                            "Chukka-Boot „Heide“",
                            "169.00",
                            "Knöchelhoher Veloursleder-Boot mit drei Ösenpaaren und leichter Kreppsohle. Passt zu Jeans wie zur Chino und wiegt kaum mehr als ein Sneaker.",
                            "chukka-heide",
                            sku="SCH-BOO-003",
                            gtin="4260410000093",
                            material="Obermaterial Veloursleder (Rind), Futter Textil, Laufsohle Naturkrepp",
                            care="Vor dem ersten Tragen imprägnieren, Flecken trocken ausbürsten. Kreppsohle nicht mit Lösungsmitteln behandeln.",
                            stock=30,
                            variants=[
                                {
                                    "size": "40",
                                    "color": "Sand",
                                    "stock": 3,
                                    "sku": "SCH-BOO-003-40-SAN",
                                },
                                {
                                    "size": "41",
                                    "color": "Sand",
                                    "stock": 4,
                                    "sku": "SCH-BOO-003-41-SAN",
                                },
                                {
                                    "size": "42",
                                    "color": "Sand",
                                    "stock": 5,
                                    "sku": "SCH-BOO-003-42-SAN",
                                },
                                {
                                    "size": "43",
                                    "color": "Sand",
                                    "stock": 3,
                                    "sku": "SCH-BOO-003-43-SAN",
                                },
                                {
                                    "size": "44",
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "SCH-BOO-003-44-SAN",
                                },
                                {
                                    "size": "40",
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "SCH-BOO-003-40-ANT",
                                },
                                {
                                    "size": "41",
                                    "color": "Anthrazit",
                                    "stock": 3,
                                    "sku": "SCH-BOO-003-41-ANT",
                                },
                                {
                                    "size": "42",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "SCH-BOO-003-42-ANT",
                                },
                                {
                                    "size": "43",
                                    "color": "Anthrazit",
                                    "stock": 3,
                                    "sku": "SCH-BOO-003-43-ANT",
                                },
                                {
                                    "size": "44",
                                    "color": "Anthrazit",
                                    "stock": 1,
                                    "sku": "SCH-BOO-003-44-ANT",
                                },
                            ],
                        ),
                        _p(
                            "Winterstiefel „Firn“",
                            "199.00",
                            "Warm gefütterter Stiefel mit Wollfutter, wasserdichter Membran und grober Wintersohle. Für Streusalz und Matsch gemacht, aktuell komplett ausverkauft.",
                            "winterstiefel-firn",
                            sku="SCH-BOO-004",
                            gtin="4260410000109",
                            material="Obermaterial Rindsleder mit Membran, Futter Schurwolle, Laufsohle Profilgummi",
                            care="Salzränder mit klarem Wasser abwaschen, danach imprägnieren. Wollfutter nur an der Luft trocknen.",
                            stock=0,
                            variants=[
                                {
                                    "size": "39",
                                    "color": "Anthrazit",
                                    "stock": 0,
                                    "sku": "SCH-BOO-004-39-ANT",
                                },
                                {
                                    "size": "40",
                                    "color": "Anthrazit",
                                    "stock": 0,
                                    "sku": "SCH-BOO-004-40-ANT",
                                },
                                {
                                    "size": "41",
                                    "color": "Anthrazit",
                                    "stock": 0,
                                    "sku": "SCH-BOO-004-41-ANT",
                                },
                                {
                                    "size": "42",
                                    "color": "Anthrazit",
                                    "stock": 0,
                                    "sku": "SCH-BOO-004-42-ANT",
                                },
                                {
                                    "size": "43",
                                    "color": "Anthrazit",
                                    "stock": 0,
                                    "sku": "SCH-BOO-004-43-ANT",
                                },
                                {
                                    "size": "44",
                                    "color": "Anthrazit",
                                    "stock": 0,
                                    "sku": "SCH-BOO-004-44-ANT",
                                },
                            ],
                        ),
                        _p(
                            "Gummistiefel „Watt“",
                            "89.00",
                            "Kurzer Naturkautschuk-Stiefel mit Textilfutter und niedrigem Schaft, der auch unter der Hose bleibt. Handgefertigt, deshalb kleine Nahtabweichungen möglich.",
                            ["gummistiefel-watt", "watt-pfuetze"],
                            sku="SCH-BOO-005",
                            gtin="4260410000116",
                            material="Obermaterial Naturkautschuk, Futter Baumwolle, Laufsohle Kautschuk mit Profil",
                            care="Innen und außen mit lauwarmem Wasser reinigen, stehend an einem dunklen Ort lagern. Direkte Sonne lässt den Kautschuk rissig werden.",
                            stock=40,
                            variants=[
                                {
                                    "size": "38",
                                    "color": "Nachtblau",
                                    "stock": 5,
                                    "sku": "SCH-BOO-005-38-NAV",
                                },
                                {
                                    "size": "40",
                                    "color": "Nachtblau",
                                    "stock": 7,
                                    "sku": "SCH-BOO-005-40-NAV",
                                },
                                {
                                    "size": "42",
                                    "color": "Nachtblau",
                                    "stock": 6,
                                    "sku": "SCH-BOO-005-42-NAV",
                                },
                                {
                                    "size": "44",
                                    "color": "Nachtblau",
                                    "stock": 4,
                                    "sku": "SCH-BOO-005-44-NAV",
                                },
                                {
                                    "size": "38",
                                    "color": "Salbei",
                                    "stock": 4,
                                    "sku": "SCH-BOO-005-38-SAL",
                                },
                                {
                                    "size": "40",
                                    "color": "Salbei",
                                    "stock": 6,
                                    "sku": "SCH-BOO-005-40-SAL",
                                },
                                {
                                    "size": "42",
                                    "color": "Salbei",
                                    "stock": 5,
                                    "sku": "SCH-BOO-005-42-SAL",
                                },
                                {
                                    "size": "44",
                                    "color": "Salbei",
                                    "stock": 3,
                                    "sku": "SCH-BOO-005-44-SAL",
                                },
                            ],
                        ),
                        _p(
                            "Stiefelette „Kastanie“",
                            "179.00",
                            "Schlanke Stiefelette mit 4 Zentimeter Blockabsatz und seitlichem Reißverschluss. Nur noch wenige Paare der letzten Lieferung.",
                            "stiefelette-kastanie",
                            sku="SCH-BOO-006",
                            gtin="4260410000123",
                            material="Obermaterial Rindsleder, Futter Leder, Absatz und Sohle Gummi",
                            care="Mit farbloser Creme pflegen, Reißverschluss gelegentlich mit Wachs behandeln. Nicht in der Waschmaschine reinigen.",
                            stock=3,
                            variants=[
                                {
                                    "size": "37",
                                    "color": "Rostrot",
                                    "stock": 1,
                                    "sku": "SCH-BOO-006-37-ROS",
                                },
                                {
                                    "size": "38",
                                    "color": "Rostrot",
                                    "stock": 0,
                                    "sku": "SCH-BOO-006-38-ROS",
                                },
                                {
                                    "size": "39",
                                    "color": "Rostrot",
                                    "stock": 1,
                                    "sku": "SCH-BOO-006-39-ROS",
                                },
                                {
                                    "size": "40",
                                    "color": "Rostrot",
                                    "stock": 1,
                                    "sku": "SCH-BOO-006-40-ROS",
                                },
                                {
                                    "size": "41",
                                    "color": "Rostrot",
                                    "stock": 0,
                                    "sku": "SCH-BOO-006-41-ROS",
                                },
                            ],
                        ),
                    ],
                ...
                (
                    ...
                    [
                        _p(
                            "Loafer „Allee“",
                            "159.00",
                            "Weicher Slipper aus Nappaleder mit gepolstertem Fußbett und flexibler Gummisohle. Trägt sich barfuß im Sommer und mit dünner Socke im Büro.",
                            ["loafer-allee", "allee-naht"],
                            sku="SCH-HAL-001",
                            gtin="4260410000130",
                            material="Obermaterial Nappaleder, Futter Leder, Laufsohle Gummi",
                            care="Mit weichem Tuch abwischen und mit farbloser Creme nachfetten. Schuhspanner verhindert Falten im weichen Leder.",
                            stock=38,
                            variants=[
                                {
                                    "size": "39",
                                    "color": "Kastanienbraun",
                                    "stock": 4,
                                    "sku": "SCH-HAL-001-39-KAS",
                                },
                                {
                                    "size": "40",
                                    "color": "Kastanienbraun",
                                    "stock": 6,
                                    "sku": "SCH-HAL-001-40-KAS",
                                },
                                {
                                    "size": "41",
                                    "color": "Kastanienbraun",
                                    "stock": 5,
                                    "sku": "SCH-HAL-001-41-KAS",
                                },
                                {
                                    "size": "42",
                                    "color": "Kastanienbraun",
                                    "stock": 4,
                                    "sku": "SCH-HAL-001-42-KAS",
                                },
                                {
                                    "size": "43",
                                    "color": "Kastanienbraun",
                                    "stock": 2,
                                    "sku": "SCH-HAL-001-43-KAS",
                                },
                                {
                                    "size": "39",
                                    "color": "Schwarz",
                                    "stock": 3,
                                    "sku": "SCH-HAL-001-39-SCW",
                                },
                                {
                                    "size": "40",
                                    "color": "Schwarz",
                                    "stock": 5,
                                    "sku": "SCH-HAL-001-40-SCW",
                                },
                                {
                                    "size": "41",
                                    "color": "Schwarz",
                                    "stock": 4,
                                    "sku": "SCH-HAL-001-41-SCW",
                                },
                                {
                                    "size": "42",
                                    "color": "Schwarz",
                                    "stock": 3,
                                    "sku": "SCH-HAL-001-42-SCW",
                                },
                                {
                                    "size": "43",
                                    "color": "Schwarz",
                                    "stock": 2,
                                    "sku": "SCH-HAL-001-43-SCW",
                                },
                            ],
                        ),
                        _p(
                            "Penny-Loafer „Kontor“",
                            "179.00",
                            "Rahmengenähter Loafer mit Sattelriemen und Ledersohle mit dünner Gummiauflage. Läuft sich in zwei bis drei Wochen auf den Fuß ein.",
                            "loafer-kontor",
                            sku="SCH-HAL-002",
                            gtin="4260410000147",
                            material="Obermaterial Boxcalf-Rindsleder, Futter Leder, Sohle Leder mit Gummiauflage",
                            care="Nach jedem dritten Tragen ausbürsten und cremen, dazwischen ruhen lassen. Ledersohle trocken halten.",
                            stock=19,
                            variants=[
                                {
                                    "size": "40",
                                    "color": "Dunkelbraun",
                                    "stock": 2,
                                    "sku": "SCH-HAL-002-40-DBR",
                                },
                                {
                                    "size": "41",
                                    "color": "Dunkelbraun",
                                    "stock": 3,
                                    "sku": "SCH-HAL-002-41-DBR",
                                },
                                {
                                    "size": "42",
                                    "color": "Dunkelbraun",
                                    "stock": 5,
                                    "sku": "SCH-HAL-002-42-DBR",
                                },
                                {
                                    "size": "43",
                                    "color": "Dunkelbraun",
                                    "stock": 4,
                                    "sku": "SCH-HAL-002-43-DBR",
                                },
                                {
                                    "size": "44",
                                    "color": "Dunkelbraun",
                                    "stock": 3,
                                    "sku": "SCH-HAL-002-44-DBR",
                                },
                                {
                                    "size": "45",
                                    "color": "Dunkelbraun",
                                    "stock": 2,
                                    "sku": "SCH-HAL-002-45-DBR",
                                },
                            ],
                        ),
                        _p(
                            "Derby „Kanzlei“",
                            "199.00",
                            "Glatter Derby mit offener Schnürung, dadurch auch für höhere Spann geeignet. Rahmengenäht und mehrfach neu besohlbar.",
                            "derby-kanzlei",
                            sku="SCH-HAL-003",
                            gtin="4260410000154",
                            material="Obermaterial Boxcalf-Rindsleder, Futter Leder, Sohle Leder rahmengenäht",
                            care="Vor dem ersten Tragen und danach monatlich cremen und polieren. Schuhspanner aus Zedernholz nach jedem Tragen einsetzen.",
                            stock=24,
                            variants=[
                                {
                                    "size": "40",
                                    "color": "Schwarz",
                                    "stock": 2,
                                    "sku": "SCH-HAL-003-40-SCW",
                                },
                                {
                                    "size": "41",
                                    "color": "Schwarz",
                                    "stock": 3,
                                    "sku": "SCH-HAL-003-41-SCW",
                                },
                                {
                                    "size": "42",
                                    "color": "Schwarz",
                                    "stock": 5,
                                    "sku": "SCH-HAL-003-42-SCW",
                                },
                                {
                                    "size": "43",
                                    "color": "Schwarz",
                                    "stock": 5,
                                    "sku": "SCH-HAL-003-43-SCW",
                                },
                                {
                                    "size": "44",
                                    "color": "Schwarz",
                                    "stock": 4,
                                    "sku": "SCH-HAL-003-44-SCW",
                                },
                                {
                                    "size": "45",
                                    "color": "Schwarz",
                                    "stock": 3,
                                    "sku": "SCH-HAL-003-45-SCW",
                                },
                                {
                                    "size": "46",
                                    "color": "Schwarz",
                                    "stock": 2,
                                    "sku": "SCH-HAL-003-46-SCW",
                                },
                            ],
                        ),
                        _p(
                            "Ballerina „Feder“",
                            "119.00",
                            "Flacher Ballerina aus weichem Ziegenleder mit elastischem Randgummi. Faltbar genug für die Tasche, mit rutschfester Ledersohle.",
                            "ballerina-feder",
                            sku="SCH-HAL-004",
                            gtin="4260410000161",
                            badge="neu",
                            material="Obermaterial Ziegenleder, Futter Leder, Sohle Leder mit Gummiauflage",
                            care="Mit weichem Tuch reinigen, farblose Pflegemilch verwenden. Nicht knicken lagern, sondern flach ausstreichen.",
                            stock=33,
                            variants=[
                                {
                                    "size": "36",
                                    "color": "Creme",
                                    "stock": 3,
                                    "sku": "SCH-HAL-004-36-CRE",
                                },
                                {
                                    "size": "37",
                                    "color": "Creme",
                                    "stock": 5,
                                    "sku": "SCH-HAL-004-37-CRE",
                                },
                                {
                                    "size": "38",
                                    "color": "Creme",
                                    "stock": 6,
                                    "sku": "SCH-HAL-004-38-CRE",
                                },
                                {
                                    "size": "39",
                                    "color": "Creme",
                                    "stock": 4,
                                    "sku": "SCH-HAL-004-39-CRE",
                                },
                                {
                                    "size": "40",
                                    "color": "Creme",
                                    "stock": 2,
                                    "sku": "SCH-HAL-004-40-CRE",
                                },
                                {
                                    "size": "36",
                                    "color": "Nachtblau",
                                    "stock": 2,
                                    "sku": "SCH-HAL-004-36-NAV",
                                },
                                {
                                    "size": "37",
                                    "color": "Nachtblau",
                                    "stock": 3,
                                    "sku": "SCH-HAL-004-37-NAV",
                                },
                                {
                                    "size": "38",
                                    "color": "Nachtblau",
                                    "stock": 4,
                                    "sku": "SCH-HAL-004-38-NAV",
                                },
                                {
                                    "size": "39",
                                    "color": "Nachtblau",
                                    "stock": 3,
                                    "sku": "SCH-HAL-004-39-NAV",
                                },
                                {
                                    "size": "40",
                                    "color": "Nachtblau",
                                    "stock": 1,
                                    "sku": "SCH-HAL-004-40-NAV",
                                },
                            ],
                        ),
                        _p(
                            "Espadrille „Salz“",
                            "69.00",
                            "Leichter Sommerschuh aus Baumwollsegeltuch auf geflochtener Jutesohle. Restposten der Saison, nur noch Einzelpaare.",
                            "espadrille-salz",
                            sku="SCH-HAL-005",
                            gtin="4260410000178",
                            material="Obermaterial Baumwollsegeltuch, Sohle Jute mit Gummiauflage",
                            care="Mit Bürste trocken reinigen, Jutesohle nicht einweichen. Bei Nässe an der Luft und mit Papier ausgestopft trocknen.",
                            stock=4,
                            variants=[
                                {
                                    "size": "37",
                                    "color": "Sand",
                                    "stock": 1,
                                    "sku": "SCH-HAL-005-37-SAN",
                                },
                                {
                                    "size": "38",
                                    "color": "Sand",
                                    "stock": 1,
                                    "sku": "SCH-HAL-005-38-SAN",
                                },
                                {
                                    "size": "39",
                                    "color": "Sand",
                                    "stock": 0,
                                    "sku": "SCH-HAL-005-39-SAN",
                                },
                                {
                                    "size": "40",
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "SCH-HAL-005-40-SAN",
                                },
                                {
                                    "size": "41",
                                    "color": "Sand",
                                    "stock": 0,
                                    "sku": "SCH-HAL-005-41-SAN",
                                },
                            ],
                        ),
                    ],
                ...
                (
                    ...
                    [
                        _p(
                            "Sandale „Kiesbett“",
                            "99.00",
                            "Zweiriemen-Sandale mit anpassbaren Schnallen und geformtem Korkfußbett. Das Fußbett nimmt nach ein paar Tagen die Form des Fußes an.",
                            "sandale-kiesbett",
                            sku="SCH-SAN-001",
                            gtin="4260410000185",
                            material="Riemen Rindsleder, Fußbett Kork-Latex mit Wildlederauflage, Laufsohle EVA",
                            care="Fußbett trocken abbürsten, Leder gelegentlich mit Pflegemilch behandeln. Nicht ins Wasser stellen, Kork löst sich sonst.",
                            stock=35,
                            variants=[
                                {
                                    "size": "37",
                                    "color": "Terrakotta",
                                    "stock": 4,
                                    "sku": "SCH-SAN-001-37-TER",
                                },
                                {
                                    "size": "38",
                                    "color": "Terrakotta",
                                    "stock": 5,
                                    "sku": "SCH-SAN-001-38-TER",
                                },
                                {
                                    "size": "39",
                                    "color": "Terrakotta",
                                    "stock": 6,
                                    "sku": "SCH-SAN-001-39-TER",
                                },
                                {
                                    "size": "40",
                                    "color": "Terrakotta",
                                    "stock": 4,
                                    "sku": "SCH-SAN-001-40-TER",
                                },
                                {
                                    "size": "41",
                                    "color": "Terrakotta",
                                    "stock": 2,
                                    "sku": "SCH-SAN-001-41-TER",
                                },
                                {
                                    "size": "37",
                                    "color": "Anthrazit",
                                    "stock": 2,
                                    "sku": "SCH-SAN-001-37-ANT",
                                },
                                {
                                    "size": "38",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "SCH-SAN-001-38-ANT",
                                },
                                {
                                    "size": "39",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "SCH-SAN-001-39-ANT",
                                },
                                {
                                    "size": "40",
                                    "color": "Anthrazit",
                                    "stock": 3,
                                    "sku": "SCH-SAN-001-40-ANT",
                                },
                                {
                                    "size": "41",
                                    "color": "Anthrazit",
                                    "stock": 1,
                                    "sku": "SCH-SAN-001-41-ANT",
                                },
                            ],
                        ),
                        _p(
                            "Zehensteg-Sandale „Ebbe“",
                            "79.00",
                            "Schlichte Sandale mit weichem Lederzehensteg und flacher Gummisohle. Wiegt wenig und passt flach in den Koffer.",
                            "sandale-ebbe",
                            sku="SCH-SAN-002",
                            gtin="4260410000192",
                            material="Riemen Rindsleder, Fußbett Leder, Laufsohle Gummi",
                            care="Mit feuchtem Tuch abwischen und an der Luft trocknen. Salzwasser nach dem Baden abspülen.",
                            stock=26,
                            variants=[
                                {
                                    "size": "37",
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "SCH-SAN-002-37-SAN",
                                },
                                {
                                    "size": "38",
                                    "color": "Sand",
                                    "stock": 4,
                                    "sku": "SCH-SAN-002-38-SAN",
                                },
                                {
                                    "size": "39",
                                    "color": "Sand",
                                    "stock": 5,
                                    "sku": "SCH-SAN-002-39-SAN",
                                },
                                {
                                    "size": "40",
                                    "color": "Sand",
                                    "stock": 6,
                                    "sku": "SCH-SAN-002-40-SAN",
                                },
                                {
                                    "size": "41",
                                    "color": "Sand",
                                    "stock": 4,
                                    "sku": "SCH-SAN-002-41-SAN",
                                },
                                {
                                    "size": "42",
                                    "color": "Sand",
                                    "stock": 3,
                                    "sku": "SCH-SAN-002-42-SAN",
                                },
                                {
                                    "size": "43",
                                    "color": "Sand",
                                    "stock": 2,
                                    "sku": "SCH-SAN-002-43-SAN",
                                },
                            ],
                        ),
                        _p(
                            "Filz-Hausschuh „Ofenbank“",
                            "59.00",
                            "Geschlossener Hausschuh aus 5 Millimeter starkem Wollfilz mit rutschfester Ledersohle. Hält die Füße warm, ohne dass sie schwitzen.",
                            ["hausschuh-ofenbank", "ofenbank-filz"],
                            sku="SCH-SAN-003",
                            gtin="4260410000208",
                            material="Obermaterial 100 % Schurwollfilz, Sohle Rindsleder mit Antirutschpunkten",
                            care="Nur mit der Hand in lauwarmem Wollwaschmittel reinigen, flach trocknen lassen. Nicht schleudern, der Filz zieht sich sonst zusammen.",
                            stock=44,
                            variants=[
                                {
                                    "size": "38",
                                    "color": "Anthrazit",
                                    "stock": 6,
                                    "sku": "SCH-SAN-003-38-ANT",
                                },
                                {
                                    "size": "40",
                                    "color": "Anthrazit",
                                    "stock": 8,
                                    "sku": "SCH-SAN-003-40-ANT",
                                },
                                {
                                    "size": "42",
                                    "color": "Anthrazit",
                                    "stock": 7,
                                    "sku": "SCH-SAN-003-42-ANT",
                                },
                                {
                                    "size": "44",
                                    "color": "Anthrazit",
                                    "stock": 4,
                                    "sku": "SCH-SAN-003-44-ANT",
                                },
                                {
                                    "size": "38",
                                    "color": "Rostrot",
                                    "stock": 4,
                                    "sku": "SCH-SAN-003-38-ROS",
                                },
                                {
                                    "size": "40",
                                    "color": "Rostrot",
                                    "stock": 6,
                                    "sku": "SCH-SAN-003-40-ROS",
                                },
                                {
                                    "size": "42",
                                    "color": "Rostrot",
                                    "stock": 5,
                                    "sku": "SCH-SAN-003-42-ROS",
                                },
                                {
                                    "size": "44",
                                    "color": "Rostrot",
                                    "stock": 4,
                                    "sku": "SCH-SAN-003-44-ROS",
                                },
                            ],
                        ),
                    ],
            ...
            "Schuhe für den Alltag, ausgewählt nach Passform und Verarbeitung: Sneaker aus Leder und Canvas, Boots für nasse Monate, Loafer und Derbys fürs Büro sowie Sandalen und Hausschuhe. Alle Modelle in ganzen Größen von 36 bis 46, viele davon in zwei Farben.",
            "",
            "kategorie-schuhe",
        ),
        (
            ...
            [
                (
                    ...
                    [
                        _p(
                            'Rolltop-Rucksack „Nordwall" 22 l',
                            "149.00",
                            "Rolltop-Rucksack aus Recycling-Nylon mit 22 Litern Volumen und gepolstertem Laptopfach bis 15 Zoll. Der Rollverschluss lässt sich um zwei Umschläge kürzen, wenn wenig drin ist. Das Obermaterial ist ein dicht gewebtes Recycling-Nylon, der Boden aus pflanzlich gegerbtem Rindsleder — die Stelle, die bei Rucksäcken zuerst durchscheuert. Innen: gepolstertes Laptopfach bis 15 Zoll, ein Reißverschlussfach für Schlüssel und Karten, zwei offene Netztaschen. Die Träger sind an vier Punkten vernäht und lassen sich beidseitig nachziehen; Schnallen und Rollverschluss können einzeln nachbestellt werden.",
                            ["backpack-rolltop", "rolltop-detail", "rolltop-street"],
                            sku="TAS-RUC-101",
                            gtin="4260118400013",
                            badge="neu",
                            material="Obermaterial 100 % Recycling-Nylon (rPET), Boden pflanzlich gegerbtes Rindsleder, YKK-Reißverschlüsse",
                            care="Feucht abwischen, nicht in die Waschmaschine. Lederboden zweimal im Jahr mit farblosem Lederbalsam einfetten.",
                            stock=24,
                            variants=[
                                {"color": "Anthrazit", "stock": 11, "sku": "TAS-RUC-101-ANT"},
                                {"color": "Nachtblau", "stock": 8, "sku": "TAS-RUC-101-NBL"},
                                {"color": "Salbei", "stock": 5, "sku": "TAS-RUC-101-SAL"},
                            ],
                        ),
                        _p(
                            'Tagesrucksack „Kiesel" 16 l',
                            "89.00",
                            "Leichter Alltagsrucksack aus gewachstem Baumwollcanvas mit 16 Litern und Laptopfach bis 13 Zoll. Ohne Hüftgurt, dafür flach am Rücken — passt in vollen Bahnen. Der Canvas ist mit Bienenwachs imprägniert und wird mit den Jahren heller an Kanten und Knicken. Ein Hauptfach mit zweiseitigem Reißverschluss, davor ein flaches Fach für Karte und Portemonnaie, innen eine Steckhülle für Tablet oder 13-Zoll-Laptop. Gewicht leer: 620 g.",
                            "backpack-canvas",
                            sku="TAS-RUC-102",
                            gtin="4260118400020",
                            material="Gewachster Baumwollcanvas 380 g/m², Innenfutter Recycling-Polyester, Lederdetails",
                            care="Flecken mit lauwarmem Wasser und Bürste abtupfen. Nach zwei bis drei Jahren mit Wachsblock nachbehandeln.",
                            stock=41,
                            variants=[
                                {"color": "Sand", "stock": 18, "sku": "TAS-RUC-102-SAN"},
                                {"color": "Anthrazit", "stock": 15, "sku": "TAS-RUC-102-ANT"},
                                {"color": "Rostrot", "stock": 8, "sku": "TAS-RUC-102-ROS"},
                            ],
                        ),
                        _p(
                            'Leder-Rucksack „Ufer"',
                            "249.00",
                            "Rucksack aus pflanzlich gegerbtem Rindsleder mit Überschlag und zwei Schnallen. Fasst Aktenordner im Format A4, Laptopfach bis 14 Zoll. Das Leder kommt aus einer süddeutschen Gerberei und ist rein pflanzlich gegerbt, also ohne Chrom. Es ist bei Lieferung matt und dunkelt an Sonnenlicht innerhalb weniger Monate nach. Die Schnallen sind aus Messing und werden mit der Zeit warm im Ton. Innen ein gefüttertes Laptopfach, zwei Steckfächer, ein Reißverschlussfach am Rücken.",
                            ["backpack-leather", "leatherpack-detail"],
                            sku="TAS-RUC-103",
                            gtin="4260118400037",
                            material="Pflanzlich gegerbtes Rindsleder 2,2 mm, Messingbeschläge, Baumwollfutter",
                            care="Trocken lagern, nicht am Heizkörper trocknen. Zweimal jährlich Lederbalsam dünn auftragen und nachpolieren.",
                            stock=3,
                            variants=[
                                {"color": "Cognac", "stock": 2, "sku": "TAS-RUC-103-COG"},
                                {"color": "Schwarz", "stock": 1, "sku": "TAS-RUC-103-SCH"},
                            ],
                        ),
                        _p(
                            'Fahrradrucksack „Steg" 20 l',
                            "119.00",
                            "Wasserdichter Rucksack mit verschweißten Nähten und Rollverschluss, 20 Liter. Reflexstreifen an Front und Trägern, Brustgurt gegen Verrutschen. Die Plane ist beidseitig beschichtet und an allen Nähten verschweißt, der Rollverschluss schließt mit drei Umschlägen dicht ab. Am Rücken sitzt ein belüftetes Polster, das den Schweiß nicht direkt in die Jacke drückt. Innen eine herausnehmbare Laptophülle bis 15 Zoll, außen eine Netztasche für die Flasche.",
                            "backpack-cycling",
                            sku="TAS-RUC-104",
                            gtin="4260118400044",
                            material="Beschichtete LKW-Plane (PVC-frei), verschweißte Nähte, reflektierende Bänder",
                            care="Mit Wasser und Schwamm abwaschen. Nicht bügeln, keine Lösungsmittel, keine Maschinenwäsche.",
                            stock=18,
                            variants=[
                                {"color": "Nachtblau", "stock": 10, "sku": "TAS-RUC-104-NBL"},
                                {"color": "Anthrazit", "stock": 8, "sku": "TAS-RUC-104-ANT"},
                            ],
                        ),
                        _p(
                            'Wanderrucksack „Föhre" 28 l',
                            "139.00",
                            "Tagestourenrucksack mit 28 Litern, Hüftgurt und Regenhülle im Bodenfach. Zugang über den Deckel und über einen seitlichen Reißverschluss. Für Tagestouren gedacht, nicht für Mehrtagesmärsche: Tragesystem mit Alu-Stab, gepolstertem Hüftgurt und zwei Kompressionsriemen. Zwei Trinkflaschenfächer aus Stretchgewebe, ein Deckelfach für Karte und Riegel, im Bodenfach eine eingenähte Regenhülle. Gewicht leer: 1,1 kg.",
                            "backpack-hiking",
                            sku="TAS-RUC-105",
                            gtin="4260118400051",
                            material="Recycling-Polyamid 210D ripstop, Aluminiumstrebe, Polsterung aus EVA-Schaum",
                            care="Mit klarem Wasser abspülen und offen trocknen lassen. Reißverschlüsse gelegentlich mit Silikonstift pflegen.",
                            stock=0,
                            variants=[
                                {"color": "Salbei", "stock": 0, "sku": "TAS-RUC-105-SAL"},
                                {"color": "Anthrazit", "stock": 0, "sku": "TAS-RUC-105-ANT"},
                            ],
                        ),
                        _p(
                            'Business-Rucksack „Kontor"',
                            "169.00",
                            "Flacher Rucksack fürs Büro mit gepolstertem Fach bis 16 Zoll und aufgeräumtem Organizer. Rückseitiger Trolleygurt für die Bahnfahrt. Der Schnitt ist bewusst schmal, damit der Rucksack unter dem Sitz im Zug bleibt. Innen: Laptopfach bis 16 Zoll mit Fleecefutter, Steckplätze für Ladegerät, Stifte und Karten, ein separates Fach für Papiere. Der Rücken hat einen Gurttunnel für den Trolleygriff und ein verstecktes Fach für Portemonnaie oder Reisepass.",
                            "backpack-office",
                            sku="TAS-RUC-106",
                            gtin="4260118400068",
                            material="Recycling-Polyester 900D mit PU-Beschichtung, Fleecefutter, Reißverschlüsse mit Lederzipper",
                            care="Feucht abwischen. Bei stärkerer Verschmutzung Handwäsche kalt, nicht schleudern.",
                            stock=12,
                            variants=[
                                {"color": "Graphit", "stock": 7, "sku": "TAS-RUC-106-GRA"},
                                {"color": "Schwarz", "stock": 5, "sku": "TAS-RUC-106-SCH"},
                            ],
                        ),
                    ],
                    "backpacks-shelf",
                ...
                (
                    ...
                    [
                        _p(
                            'Canvas-Shopper „Markttag"',
                            "59.00",
                            "Großer Shopper aus schwerem Baumwollcanvas mit verstärktem Boden und langen Tragegriffen. Trägt bequem zwölf Kilo vom Markt nach Hause. Die Griffe sind über den ganzen Boden durchgenäht, damit das Gewicht nicht an der Naht hängt. Innen eine Reißverschlusstasche für Schlüssel und Geld, außen zwei offene Taschen für Zeitung oder Wasserflasche. Der Boden ist doppelt gelegt und mit einem herausnehmbaren Einleger versteift. Maße: 40 × 42 × 16 cm.",
                            ["tote-canvas", "totecanvas-market", "totecanvas-detail"],
                            sku="TAS-SHO-201",
                            gtin="4260118400075",
                            badge="beliebt",
                            material="Baumwollcanvas 500 g/m² (kbA), Gurtbänder aus Baumwolle, Lederpatch",
                            care="Maschinenwäsche 30 °C ohne Weichspüler, Einleger vorher herausnehmen. Liegend trocknen.",
                            stock=63,
                            variants=[
                                {"color": "Natur", "stock": 24, "sku": "TAS-SHO-201-NAT"},
                                {"color": "Salbei", "stock": 16, "sku": "TAS-SHO-201-SAL"},
                                {"color": "Nachtblau", "stock": 13, "sku": "TAS-SHO-201-NBL"},
                                {"color": "Terrakotta", "stock": 10, "sku": "TAS-SHO-201-TER"},
                            ],
                        ),
                        _p(
                            'Leder-Shopper „Auwald"',
                            "219.00",
                            "Weicher Shopper aus genarbtem Rindsleder, offen zu tragen und mit Magnetdruckknopf zu schließen. A4-Ordner und Laptop passen aufrecht hinein. Das Leder ist weich zugerichtet und legt sich nach wenigen Wochen in Falten — gewollt, denn eine steife Tasche steht im Alltag im Weg. Innen ein abnehmbares Zip-Etui am Karabiner, zwei Steckfächer, ein Reißverschlussfach. Die Henkel sind lang genug für die Schulter, auch über dem Mantel. Maße: 33 × 38 × 13 cm.",
                            "tote-leather",
                            sku="TAS-SHO-202",
                            gtin="4260118400082",
                            material="Genarbtes Rindsleder 1,4 mm, Innenfutter Baumwolltwill, Beschläge mattiert",
                            care="Vor Nässe schützen, Regentropfen sofort abtupfen. Einmal jährlich mit Lederpflegemilch behandeln.",
                            stock=9,
                            variants=[
                                {"color": "Cognac", "stock": 4, "sku": "TAS-SHO-202-COG"},
                                {"color": "Schwarz", "stock": 3, "sku": "TAS-SHO-202-SCH"},
                                {"color": "Anthrazit", "stock": 2, "sku": "TAS-SHO-202-ANT"},
                            ],
                        ),
                        _p(
                            'Umhängetasche „Espe"',
                            "139.00",
                            "Kleine Crossbody-Tasche aus Glattleder für Handy, Portemonnaie und Schlüssel. Der Gurt ist von 95 bis 130 cm stufenlos verstellbar. Gedacht für Tage, an denen nur das Nötigste mitgeht: ein Hauptfach mit Reißverschluss, davor ein Steckfach in Handygröße, hinten ein Fach für Tickets. Der Gurt lässt sich abnehmen, ein breiter Textilgurt ist separat erhältlich. Maße: 18 × 22 × 7 cm.",
                            "crossbody-leather",
                            sku="TAS-SHO-203",
                            gtin="4260118400099",
                            material="Glattes Rindsleder 1,6 mm, Futter aus Recycling-Polyester, Karabiner aus Messing",
                            care="Mit weichem Tuch abwischen, keine Reinigungsmittel. Bei Bedarf farbloses Lederfett dünn auftragen.",
                            stock=22,
                            variants=[
                                {"color": "Cognac", "stock": 9, "sku": "TAS-SHO-203-COG"},
                                {"color": "Schwarz", "stock": 8, "sku": "TAS-SHO-203-SCH"},
                                {"color": "Creme", "stock": 5, "sku": "TAS-SHO-203-CRE"},
                            ],
                        ),
                        _p(
                            'Gürteltasche „Ranke"',
                            "69.00",
                            "Gürteltasche aus Recycling-Nylon, quer über der Brust oder an der Hüfte zu tragen. Zwei getrennte Fächer, damit Schlüssel nicht am Handy kratzen. Der Gurt ist bis 140 cm lang und mit einer Steckschnalle zu öffnen, ohne ihn über den Kopf zu ziehen. Hauptfach mit gefüttertem Handyplatz, vorne ein flaches Reißverschlussfach, an der Rückseite ein Schlüsselband. Gewicht leer: 180 g.",
                            "beltbag-nylon",
                            sku="TAS-SHO-204",
                            gtin="4260118400105",
                            material="Recycling-Nylon (rPET) mit Wasserabweisung, Steckschnalle aus Kunststoff, gefüttertes Innenfach",
                            care="Handwäsche kalt, an der Luft trocknen. Kein Trockner, keine chemische Reinigung.",
                            stock=35,
                            variants=[
                                {"color": "Schwarz", "stock": 15, "sku": "TAS-SHO-204-SCH"},
                                {"color": "Salbei", "stock": 12, "sku": "TAS-SHO-204-SAL"},
                                {"color": "Rostrot", "stock": 8, "sku": "TAS-SHO-204-ROS"},
                            ],
                        ),
                        _p(
                            'Beuteltasche „Moorlicht"',
                            "129.00",
                            "Bucket Bag aus Veloursleder mit Tunnelzug und Innenbeutel. Fasst mehr, als sie von außen vermuten lässt. Der Tunnelzug schließt oben zusammen, der eingenähte Innenbeutel hält Kleinteile davon ab, nach unten zu rutschen. Innen ein Reißverschlussfach und zwei Steckfächer. Der Schulterriemen ist in drei Stufen verstellbar, zusätzlich liegt ein kurzer Handgriff bei. Maße: 26 × 24 × 15 cm.",
                            "bucketbag-suede",
                            sku="TAS-SHO-205",
                            gtin="4260118400112",
                            material="Veloursleder (Rind), Innenbeutel aus Baumwolltwill, Kordel aus Leder",
                            care="Regelmäßig mit Veloursbürste aufrauen. Nicht wischen, kein Wasser — Flecken trocken ausbürsten.",
                            stock=14,
                            variants=[
                                {"color": "Terrakotta", "stock": 8, "sku": "TAS-SHO-205-TER"},
                                {"color": "Anthrazit", "stock": 6, "sku": "TAS-SHO-205-ANT"},
                            ],
                        ),
                        _p(
                            'Einkaufsnetz „Hafen"',
                            "24.00",
                            "Gehäkeltes Einkaufsnetz aus Bio-Baumwolle, das sich auf Faustgröße zusammenlegen lässt. Dehnt sich auf rund 20 Liter. Klassisches Netz mit kurzen Henkeln, das in jede Manteltasche passt und beim Einkauf zwei Wasserkästen ersetzt — jedenfalls das Gewicht einer vollen Papiertüte. Die Maschen geben nach und ziehen sich beim Waschen wieder zusammen. Leergewicht: 95 g.",
                            "netbag-cotton",
                            sku="TAS-SHO-206",
                            gtin="4260118400129",
                            material="100 % Bio-Baumwolle, gehäkelt, ungefärbte Henkel",
                            care="Maschinenwäsche 40 °C im Wäschenetz. Nicht in den Trockner, feucht in Form ziehen.",
                            stock=78,
                            variants=[
                                {"color": "Natur", "stock": 34, "sku": "TAS-SHO-206-NAT"},
                                {"color": "Nachtblau", "stock": 25, "sku": "TAS-SHO-206-NBL"},
                                {"color": "Salbei", "stock": 19, "sku": "TAS-SHO-206-SAL"},
                            ],
                        ),
                    ],
                    "handbags-shelf",
                ...
                (
                    ...
                    [
                        _p(
                            'Portemonnaie „Talsohle"',
                            "69.00",
                            "Geldbörse mit umlaufendem Reißverschluss, acht Kartenfächern und getrenntem Münzfach. Bleibt flach, auch wenn sie voll ist. Der umlaufende Reißverschluss hält alles beisammen, wenn die Börse in der Manteltasche steckt. Innen: acht Kartenfächer, zwei Scheinfächer, ein Münzfach mit eigenem Zipper und ein Sichtfenster für die Monatskarte. Maße geschlossen: 11 × 9,5 × 2,5 cm.",
                            ["wallet-leather", "wallet-open"],
                            sku="TAS-KLW-301",
                            gtin="4260118400136",
                            material="Pflanzlich gegerbtes Rindsleder 1,2 mm, Futter aus Baumwolle, Metallreißverschluss",
                            care="Trocken halten, nicht in die Gesäßtasche stecken. Einmal jährlich mit Lederbalsam nachfetten.",
                            stock=47,
                            variants=[
                                {"color": "Cognac", "stock": 20, "sku": "TAS-KLW-301-COG"},
                                {"color": "Schwarz", "stock": 17, "sku": "TAS-KLW-301-SCH"},
                                {"color": "Nachtblau", "stock": 10, "sku": "TAS-KLW-301-NBL"},
                            ],
                        ),
                        _p(
                            'Kartenetui „Splitt"',
                            "34.00",
                            "Flaches Etui für sechs Karten und ein paar gefaltete Scheine. Passt in die Hemdtasche, ohne aufzutragen. Aus einem Stück Leder gefaltet und an zwei Kanten vernäht, ohne Futter — dadurch bleibt es dünn und formt sich nach den Karten. Drei Steckfächer auf jeder Seite, mittig ein Fach für Scheine. Maße: 10 × 7,5 × 0,7 cm.",
                            "cardholder-slim",
                            sku="TAS-KLW-302",
                            gtin="4260118400143",
                            material="Pflanzlich gegerbtes Rindsleder 1,0 mm, Sattlernaht mit Leinengarn",
                            care="Trocken abreiben. Neue Karten anfangs stramm, das Leder gibt nach zwei Wochen nach.",
                            stock=56,
                            variants=[
                                {"color": "Schwarz", "stock": 24, "sku": "TAS-KLW-302-SCH"},
                                {"color": "Cognac", "stock": 20, "sku": "TAS-KLW-302-COG"},
                                {"color": "Salbei", "stock": 12, "sku": "TAS-KLW-302-SAL"},
                            ],
                        ),
                        _p(
                            'Schlüsseletui „Zunder"',
                            "29.00",
                            "Etui mit vier Schlüsselhaken und Druckknopf, damit die Schlüssel die Jackentasche nicht durchlöchern. Ein Ring bleibt außen für den Autoschlüssel. Innen sitzen vier bewegliche Haken auf einer Schiene, außen ein D-Ring für einen fünften Schlüssel oder den Chip. Der Druckknopf ist aus Messing und lässt sich einhändig öffnen. Maße: 10 × 5 cm.",
                            "keycase-leather",
                            sku="TAS-KLW-303",
                            gtin="4260118400150",
                            material="Pflanzlich gegerbtes Rindsleder 1,6 mm, Schlüsselschiene und Druckknopf aus Messing",
                            care="Trocken abwischen, gelegentlich Lederbalsam. Haken bei Bedarf nachziehen.",
                            stock=31,
                            variants=[
                                {"color": "Cognac", "stock": 18, "sku": "TAS-KLW-303-COG"},
                                {"color": "Anthrazit", "stock": 13, "sku": "TAS-KLW-303-ANT"},
                            ],
                        ),
                        _p(
                            'Kulturbeutel „Brandung"',
                            "79.00",
                            "Kulturbeutel aus beschichtetem Canvas mit abwischbarem Innenfutter und Haken zum Aufhängen. Steht auch auf schmalen Ablagen sicher. Der Boden ist versteift, damit der Beutel offen stehen bleibt und man nicht mit einer Hand hineingreifen muss. Innen ein abwischbares Futter, zwei Netzfächer und ein Gummiband für die Zahnbürste; außen ein Reißverschlussfach für Rasierer oder Nagelschere. Mit ausklappbarem Haken für Tür oder Handtuchstange. Maße: 24 × 14 × 12 cm.",
                            "washbag-canvas",
                            sku="TAS-KLW-304",
                            gtin="4260118400167",
                            material="Beschichteter Baumwollcanvas, Innenfutter aus abwischbarem Recycling-Polyester, Lederzipper",
                            care="Innen feucht auswischen, außen mit Bürste reinigen. Nicht in die Maschine.",
                            stock=26,
                            variants=[
                                {"color": "Sand", "stock": 15, "sku": "TAS-KLW-304-SAN"},
                                {"color": "Anthrazit", "stock": 11, "sku": "TAS-KLW-304-ANT"},
                            ],
                        ),
                    ],
                    "wallets-shelf",
                ...
                (
                    ...
                    [
                        _p(
                            'Weekender „Fernweg"',
                            "189.00",
                            "Reisetasche aus Canvas mit Lederboden, 42 Liter — genug für drei Tage. Abnehmbarer Schultergurt, Gurttunnel für den Trolleygriff. Die Tasche öffnet sich über die volle Länge, sodass man nicht blind im Inneren wühlt. Zwei Endfächer für Schuhe oder Wäschebeutel, innen eine Reißverschlusstasche, außen zwei Steckfächer für Ticket und Ladekabel. Der Lederboden schützt beim Abstellen auf dem Bahnsteig. Maße: 34 × 55 × 26 cm.",
                            ["duffel-canvas", "duffel-train", "duffel-detail"],
                            sku="TAS-REI-401",
                            gtin="4260118400174",
                            material="Baumwollcanvas 480 g/m², Boden und Griffe aus Rindsleder, Metallreißverschluss mit zwei Schiebern",
                            care="Canvas trocken ausbürsten, Flecken punktuell mit Seifenlauge. Lederteile zweimal jährlich pflegen.",
                            stock=11,
                            variants=[
                                {"color": "Sand", "stock": 6, "sku": "TAS-REI-401-SAN"},
                                {"color": "Anthrazit", "stock": 5, "sku": "TAS-REI-401-ANT"},
                            ],
                        ),
                        _p(
                            'Trolley „Bahnsteig"',
                            "279.00",
                            "Hartschalen-Trolley aus recyceltem Polycarbonat mit vier Leichtlaufrollen und TSA-Schloss. In Kabinengröße 55 cm und als Aufgabegepäck 68 cm. Die Schale ist aus recyceltem Polycarbonat tiefgezogen, geriffelt und dadurch unempfindlich gegen Kratzer aus dem Gepäckband. Innen zwei Packseiten mit Kreuzgurten und Netzabdeckung, im Deckel ein Reißverschlussfach. Der Griff rastet in drei Höhen ein; Rollen und Griff sind als Ersatzteil bestellbar. Kabinengröße 55 × 40 × 22 cm (38 l), großes Modell 68 × 45 × 27 cm (72 l).",
                            "suitcase-cabin",
                            sku="TAS-REI-402",
                            gtin="4260118400181",
                            material="Recyceltes Polycarbonat, Aluminium-Teleskopgriff, vier Doppelrollen mit Kugellager, TSA-Zahlenschloss",
                            care="Schale feucht abwischen. Rollen gelegentlich von Haaren und Fäden befreien, Innenfutter absaugen.",
                            stock=2,
                            variants=[
                                {
                                    "size": "55 cm",
                                ...
                                },
                                {
                                    ...
                                    "price": "329.00",
                                    "stock": 0,
                                    "sku": "TAS-REI-402-68-SAL",
                                },
                            ],
                        ),
                        _p(
                            'Laptophülle „Blatt" 14 Zoll',
                            "49.00",
                            "Gefilzte Hülle für Notebooks bis 14 Zoll, mit Magnetverschluss und einem Außenfach für Netzteil und Kabel. Passt zusätzlich in Rucksack oder Shopper. Der Wollfilz ist 3 mm stark und fängt Stöße ab, ohne aufzutragen — die Hülle passt auch dann noch in den Tagesrucksack, wenn er schon halb voll ist. Innen unbehandelt, damit das Gehäuse nicht verkratzt; außen eine Tasche in Netzteilgröße. Maße innen: 33 × 23 cm.",
                            "sleeve-felt",
                            sku="TAS-REI-403",
                            gtin="4260118400198",
                            material="Wollfilz 3 mm (80 % Schurwolle), Lederlasche, Magnetverschluss",
                            care="Fusseln mit Kleiderbürste entfernen, Flecken vorsichtig mit Wollwaschmittel abtupfen. Nicht waschen.",
                            stock=44,
                            variants=[
                                {"color": "Anthrazit", "stock": 19, "sku": "TAS-REI-403-ANT"},
                                {"color": "Sand", "stock": 15, "sku": "TAS-REI-403-SAN"},
                                {"color": "Rostrot", "stock": 10, "sku": "TAS-REI-403-ROS"},
                            ],
                        ),
                        _p(
                            'Messenger-Tasche „Kurier"',
                            "159.00",
                            "Umhängetasche im Kurierschnitt aus Recycling-Nylon, mit gepolstertem Fach bis 15 Zoll. Der Überschlag schließt mit Klettband und zwei Steckschnallen. Der Schnitt ist flach und breit, damit die Tasche beim Radfahren am Rücken bleibt und nicht nach vorn schwingt. Unter dem Überschlag zwei offene Fächer und ein Reißverschlussfach, hinten ein Schnellzugriff für Ticket und Handy. Der Gurt ist gepolstert und mit einer Hand nachzuziehen. Maße: 30 × 40 × 12 cm.",
                            "messenger-nylon",
                            sku="TAS-REI-404",
                            gtin="4260118400204",
                            badge="neu",
                            material="Recycling-Nylon 600D mit wasserabweisender Beschichtung, gepolstertes Laptopfach, Steckschnallen aus Kunststoff",
                            care="Feucht abwischen, bei Bedarf Handwäsche kalt. Klettband regelmäßig von Fusseln befreien.",
                            stock=16,
                            variants=[
                                {"color": "Schwarz", "stock": 9, "sku": "TAS-REI-404-SCH"},
                                {"color": "Nachtblau", "stock": 7, "sku": "TAS-REI-404-NBL"},
                            ],
                        ),
                    ],
                    "luggage-shelf",
            ...
            "Rucksäcke, Shopper, Umhängetaschen, Kleinlederwaren und Reisegepäck aus Canvas, pflanzlich gegerbtem Rindsleder und Recycling-Nylon. Alle Modelle sind für den Alltag gebaut: verstärkte Böden, gepolsterte Laptopfächer, nachbestellbare Gurte und Schnallen.",
            "",
            "bags-collection",
        ),
        (
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Feine Gliederkette „Halm“",
                            "69.00",
                            "Zarte Ankerkette aus 925 Silber mit Karabinerverschluss, wahlweise 45 oder 50 cm lang. Trägt sich allein oder als unterste Lage in einem Ketten-Mix.",
                            ["kette-halm", "detail-kettehalm", "look-kettehalm"],
                            sku="SA-KET-101",
                            gtin="4260101000015",
                            badge="beliebt",
                            material="925 Sterlingsilber, rhodiniert",
                            care="Mit einem Poliertuch trocken reinigen, vor Sport und Duschen ablegen.",
                            stock=34,
                            variants=[
                                {"size": "45 cm", "stock": 18, "sku": "SA-KET-101-45"},
                                {"size": "50 cm", "stock": 16, "sku": "SA-KET-101-50"},
                            ],
                        ),
                        _p(
                            "Anhängerkette „Kiesel“",
                            "89.00",
                            "Vergoldete Kette mit ovalem Anhänger aus mattiertem Mondstein, 42 cm lang mit Verlängerung auf 47 cm. Jeder Stein hat eine eigene Maserung.",
                            "kette-kiesel",
                            sku="SA-KET-102",
                            gtin="4260101000022",
                            material="Messing, 18 Karat vergoldet, Mondstein",
                            care="Vergoldung nicht mit Parfum oder Creme in Kontakt bringen, trocken aufbewahren.",
                            stock=12,
                        ),
                        _p(
                            "Bandring „Dorn“",
                            "49.00",
                            "Schmaler Bandring, 2 mm breit, mit von Hand gehämmerter Oberfläche. Lässt sich gut mit weiteren Ringen stapeln.",
                            "ring-dorn",
                            sku="SA-RNG-201",
                            gtin="4260102000019",
                            material="925 Sterlingsilber",
                            care="Bei Anlaufen mit Silberputztuch aufpolieren.",
                            stock=55,
                            variants=[
                                {"size": "52", "stock": 8, "sku": "SA-RNG-201-52"},
                                {"size": "54", "stock": 14, "sku": "SA-RNG-201-54"},
                                {"size": "56", "stock": 16, "sku": "SA-RNG-201-56"},
                                {"size": "58", "stock": 11, "sku": "SA-RNG-201-58"},
                                {"size": "60", "stock": 6, "sku": "SA-RNG-201-60"},
                            ],
                        ),
                        _p(
                            "Siegelring „Firn“",
                            "79.00",
                            "Siegelring mit ovaler, polierter Platte auf kräftiger Schiene. Die Platte lässt sich auf Wunsch gravieren.",
                            "ring-firn",
                            sku="SA-RNG-202",
                            gtin="4260102000026",
                            material="Messing, 18 Karat vergoldet",
                            care="Nur trocken reinigen, Kontakt mit Reinigungsmitteln vermeiden.",
                            stock=33,
                            variants=[
                                {"size": "52", "stock": 4, "sku": "SA-RNG-202-52"},
                                {"size": "54", "stock": 9, "sku": "SA-RNG-202-54"},
                                {"size": "56", "stock": 10, "sku": "SA-RNG-202-56"},
                                {"size": "58", "stock": 7, "sku": "SA-RNG-202-58"},
                                {"size": "60", "stock": 3, "sku": "SA-RNG-202-60"},
                            ],
                        ),
                        _p(
                            "Ohrstecker „Linde“",
                            "39.00",
                            "Runde Ohrstecker mit 6 mm Durchmesser und leicht gewölbter Oberfläche. Stifte und Verschlüsse ebenfalls aus Silber, dadurch gut für empfindliche Ohrläppchen.",
                            ["ohrstecker-linde", "detail-ohrlinde"],
                            sku="SA-OHR-301",
                            gtin="4260103000016",
                            material="925 Sterlingsilber",
                            care="Über Nacht ablegen und trocken aufbewahren.",
                            stock=41,
                        ),
                        _p(
                            "Creolen „Ebbe“",
                            "59.00",
                            "Mittelgroße Creolen mit 24 mm Durchmesser und Klappverschluss. Hohl gearbeitet und damit leicht genug für den ganzen Tag.",
                            "creolen-ebbe",
                            sku="SA-OHR-302",
                            gtin="4260103000023",
                            badge="neu",
                            material="Messing, 18 Karat vergoldet",
                            care="Vergoldung schonend behandeln, nicht im Ultraschallbad reinigen.",
                            stock=27,
                        ),
                        _p(
                            "Ohrhänger „Farn“",
                            "65.00",
                            "Längliche Ohrhänger mit beweglichem Blattelement, 4 cm lang. Sie schwingen mit und fangen dabei Licht.",
                            "ohrhaenger-farn",
                            sku="SA-OHR-303",
                            gtin="4260103000030",
                            material="925 Sterlingsilber",
                            care="Einzeln aufbewahren, damit sich die Elemente nicht verhaken.",
                            stock=0,
                        ),
                        _p(
                            "Gliederarmband „Ufer“",
                            "79.00",
                            "Flaches Panzerarmband aus 925 Silber, 19 cm lang, mit Sicherheitsöse. Der Verschluss lässt sich einhändig schließen.",
                            "armband-ufer",
                            sku="SA-ARM-401",
                            gtin="4260104000013",
                            material="925 Sterlingsilber",
                            care="Mit Poliertuch nachpolieren, Kontakt mit Chlorwasser vermeiden.",
                            stock=22,
                        ),
                        _p(
                            "Armreif „Moos“",
                            "55.00",
                            "Offener Armreif, 3 mm stark, mit leicht versetzten Enden. Die Öffnung lässt sich vorsichtig an das Handgelenk anpassen.",
                            "armreif-moos",
                            sku="SA-ARM-402",
                            gtin="4260104000020",
                            material="Messing, 18 Karat vergoldet",
                            care="Nur einmal nachjustieren, häufiges Biegen schadet der Form.",
                            stock=18,
                        ),
                        _p(
                            "Perlenarmband „Gischt“",
                            "69.00",
                            "Barocke Süßwasserperlen auf Seidenfaden, zwischen den Perlen einzeln geknotet, mit Silberverschluss. Jede Perle hat eine eigene Form.",
                            "armband-gischt",
                            sku="SA-ARM-403",
                            gtin="4260104000037",
                            material="Süßwasserperlen, 925 Sterlingsilber",
                            care="Als Letztes anlegen und als Erstes ablegen, nicht in Wasser tauchen.",
                            stock=15,
                        ),
                    ],
                    "sub-feinschmuck",
                ...
                (
                    ...
                    [
                        _p(
                            "Wollschal „Nebel“",
                            "79.00",
                            "Weich gewalkter Schal aus Lambswool, 180 × 35 cm, mit offenen Fransen. Wärmt, ohne dick aufzutragen.",
                            ["schal-nebel", "detail-schalnebel", "look-schalnebel"],
                            sku="SA-SCH-501",
                            gtin="4260105000010",
                            badge="neu",
                            material="100 % Lambswool",
                            care="Handwäsche mit Wollwaschmittel oder Reinigung, liegend trocknen.",
                            stock=26,
                            variants=[
                                {"color": "Sand", "stock": 10, "sku": "SA-SCH-501-SA"},
                                {"color": "Anthrazit", "stock": 9, "sku": "SA-SCH-501-AN"},
                                {"color": "Salbei", "stock": 7, "sku": "SA-SCH-501-SB"},
                            ],
                        ),
                        _p(
                            "Seidentuch „Ahorn“",
                            "89.00",
                            "Quadratisches Tuch aus Seidentwill, 90 × 90 cm, mit handrolliertem Saum. Das Blattmuster ist in gedeckten Tönen gedruckt.",
                            "tuch-ahorn",
                            sku="SA-SCH-502",
                            gtin="4260105000027",
                            material="100 % Seide",
                            care="Nur chemisch reinigen lassen, kühl bügeln.",
                            stock=3,
                            variants=[
                                {"color": "Rostrot", "stock": 2, "sku": "SA-SCH-502-RO"},
                                {"color": "Nachtblau", "stock": 1, "sku": "SA-SCH-502-NB"},
                            ],
                        ),
                        _p(
                            "Strickmütze „Birke“",
                            "45.00",
                            "Fein geripptes Beanie aus Merinowolle mit doppeltem Umschlag. Die Innenseite liegt glatt an der Stirn an und kratzt nicht.",
                            "muetze-birke",
                            sku="SA-MTZ-601",
                            gtin="4260106000017",
                            material="100 % Merinowolle",
                            care="Handwäsche kalt, liegend trocknen, nicht in den Trockner.",
                            stock=31,
                            variants=[
                                {"color": "Creme", "stock": 12, "sku": "SA-MTZ-601-CR"},
                                {"color": "Anthrazit", "stock": 11, "sku": "SA-MTZ-601-AN"},
                                {"color": "Rostrot", "stock": 8, "sku": "SA-MTZ-601-RO"},
                            ],
                        ),
                        _p(
                            "Stirnband „Salz“",
                            "29.00",
                            "Breites Stirnband aus Zopfstrick, innen mit einem Fleecestreifen gefüttert. Hält die Ohren warm und die Frisur frei.",
                            "stirnband-salz",
                            sku="SA-MTZ-602",
                            gtin="4260106000024",
                            material="Wollmischung mit Fleecefutter",
                            care="Handwäsche kalt, in Form ziehen und liegend trocknen.",
                            stock=24,
                            variants=[
                                {"color": "Creme", "stock": 13, "sku": "SA-MTZ-602-CR"},
                                {"color": "Salbei", "stock": 11, "sku": "SA-MTZ-602-SB"},
                            ],
                        ),
                        _p(
                            "Karoschal „Zeder“",
                            "69.00",
                            "Großer Schal im gedeckten Karo, 200 × 60 cm, aus gebürsteter Wolle. Breit genug, um ihn als Schultertuch zu tragen.",
                            "schal-zeder",
                            sku="SA-SCH-503",
                            gtin="4260105000034",
                            material="80 % Wolle, 20 % Polyamid",
                            care="Reinigung empfohlen, Fransen nur ausschütteln, nicht bürsten.",
                            stock=19,
                            variants=[
                                {"color": "Terrakotta", "stock": 9, "sku": "SA-SCH-503-TE"},
                                {"color": "Nachtblau", "stock": 10, "sku": "SA-SCH-503-NB"},
                            ],
                        ),
                    ],
                    "sub-schals",
                ...
                (
                    ...
                    [
                        _p(
                            "Ledergürtel „Kork“",
                            "69.00",
                            "Gürtel aus pflanzlich gegerbtem Rindsleder, 3,5 cm breit, mit gebürsteter Messingschnalle. Die Kanten sind von Hand gefärbt und geglättet.",
                            ["guertel-kork", "detail-guertelkork"],
                            sku="SA-GUR-701",
                            gtin="4260107000014",
                            material="Rindsleder, pflanzlich gegerbt; Schnalle aus Massivmessing",
                            care="Gelegentlich mit Lederbalsam einreiben, nicht nass werden lassen.",
                            stock=37,
                            variants=[
                                {"size": "85", "stock": 6, "sku": "SA-GUR-701-85"},
                                {"size": "90", "stock": 9, "sku": "SA-GUR-701-90"},
                                {"size": "95", "stock": 11, "sku": "SA-GUR-701-95"},
                                {"size": "100", "stock": 7, "sku": "SA-GUR-701-100"},
                                {"size": "105", "stock": 4, "sku": "SA-GUR-701-105"},
                            ],
                        ),
                        _p(
                            "Schmalgürtel „Tau“",
                            "55.00",
                            "Nur 2 cm breiter Gürtel mit kleiner Dornschließe. Passt in die Schlaufen von Hosen ebenso wie über ein Kleid.",
                            "guertel-tau",
                            sku="SA-GUR-702",
                            gtin="4260107000021",
                            material="Rindsleder, Schnalle aus vernickeltem Messing",
                            care="Mit einem trockenen Tuch abwischen, flach oder hängend lagern.",
                            stock=31,
                            variants=[
                                {"size": "85", "stock": 5, "sku": "SA-GUR-702-85"},
                                {"size": "90", "stock": 8, "sku": "SA-GUR-702-90"},
                                {"size": "95", "stock": 9, "sku": "SA-GUR-702-95"},
                                {"size": "100", "stock": 6, "sku": "SA-GUR-702-100"},
                                {"size": "105", "stock": 3, "sku": "SA-GUR-702-105"},
                            ],
                        ),
                        _p(
                            "Flechtgürtel „Saum“",
                            "59.00",
                            "Aus schmalen Lederriemen von Hand geflochten und dadurch stufenlos verstellbar – der Dorn greift zwischen die Maschen. Passt sich mit der Zeit der Trageweise an.",
                            "guertel-saum",
                            sku="SA-GUR-703",
                            gtin="4260107000038",
                            material="Rindsleder, geflochten; Schnalle aus Messing",
                            care="Nicht mit Wachs behandeln, das Geflecht sonst verkleben kann.",
                            stock=32,
                            variants=[
                                {"size": "85", "stock": 7, "sku": "SA-GUR-703-85"},
                                {"size": "90", "stock": 10, "sku": "SA-GUR-703-90"},
                                {"size": "95", "stock": 8, "sku": "SA-GUR-703-95"},
                                {"size": "100", "stock": 5, "sku": "SA-GUR-703-100"},
                                {"size": "105", "stock": 2, "sku": "SA-GUR-703-105"},
                            ],
                        ),
                    ],
                    "sub-guertel",
                ...
                (
                    ...
                    [
                        _p(
                            "Sonnenbrille „Düne“",
                            "129.00",
                            "Runde Fassung aus italienischem Acetat mit grauen Gläsern der Kategorie 3. Etui und Mikrofasertuch liegen bei.",
                            ["brille-duene", "detail-brilleduene"],
                            sku="SA-BRI-801",
                            gtin="4260108000011",
                            material="Acetat, Gläser Kat. 3 mit UV-400-Schutz",
                            care="Nur mit dem beiliegenden Tuch reinigen, nicht im Auto liegen lassen.",
                            stock=4,
                            variants=[
                                {"color": "Creme", "stock": 3, "sku": "SA-BRI-801-CR"},
                                {"color": "Anthrazit", "stock": 1, "sku": "SA-BRI-801-AN"},
                            ],
                        ),
                        _p(
                            "Sonnenbrille „Licht“",
                            "139.00",
                            "Eckige Fassung mit schmalem Steg und braun verlaufenden Gläsern der Kategorie 3. Federscharniere geben am Bügel nach und sitzen auch auf breiteren Köpfen bequem.",
                            "brille-licht",
                            sku="SA-BRI-802",
                            gtin="4260108000028",
                            material="Acetat mit Federscharnieren, Gläser Kat. 3 mit UV-400-Schutz",
                            care="Mit lauwarmem Wasser abspülen und trocken tupfen, kein Alkohol.",
                            stock=13,
                            variants=[
                                {"color": "Anthrazit", "stock": 7, "sku": "SA-BRI-802-AN"},
                                {"color": "Terrakotta", "stock": 6, "sku": "SA-BRI-802-TE"},
                            ],
                        ),
                        _p(
                            "Haarspange „Wolke“",
                            "24.00",
                            "Große Haarklammer aus Acetat, 9 cm lang, mit kräftiger Feder aus Edelstahl. Hält auch dickes und langes Haar zuverlässig.",
                            "haarspange-wolke",
                            sku="SA-HAA-901",
                            gtin="4260109000018",
                            material="Acetat, Federmechanik aus Edelstahl",
                            care="Nicht auf harten Boden fallen lassen, Acetat kann splittern.",
                            stock=38,
                            variants=[
                                {"color": "Creme", "stock": 14, "sku": "SA-HAA-901-CR"},
                                {"color": "Anthrazit", "stock": 13, "sku": "SA-HAA-901-AN"},
                                {"color": "Terrakotta", "stock": 11, "sku": "SA-HAA-901-TE"},
                            ],
                        ),
                    ],
                    "sub-brillen",
            ...
            "Feiner Schmuck aus 925 Silber und vergoldetem Messing, dazu Schals, Mützen, Gürtel, Sonnenbrillen und Haarschmuck. Kleine Serien in gedeckten Farben, die sich untereinander und mit unseren Basics kombinieren lassen.",
            "",
            "cat-schmuck",
        ),
        (
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Wolldecke „Fjord“",
                            "129.00",
                            "Grob gewebte Decke aus Lambswool mit schmaler Kettelkante. Schwer genug, um liegen zu bleiben, und trotzdem atmungsaktiv.",
                            ["decke-fjord-lambswool", "decke-fjord-struktur"],
                            sku="WT-DEC-501",
                            gtin="4261050000001",
                            badge="beliebt",
                            material="100 % Lambswool",
                            care="Nur chemisch reinigen, nicht schleudern.",
                            stock=24,
                            variants=[
                                {
                                    "size": "130 × 170 cm",
                        ...
                        _p(
                            "Waffelpiqué-Plaid „Ebbe“",
                            "79.00",
                            "Leichte Baumwolldecke in Waffelstruktur, die im Sommer auf dem Sofa und im Winter über der Bettdecke liegt.",
                            "plaid-ebbe-waffel",
                            sku="WT-DEC-502",
                            gtin="4261050000018",
                            material="100 % Baumwolle, gewaschen",
                            care="40 °C, Trockner bei niedriger Stufe möglich.",
                            stock=31,
                            variants=[
                                {"color": "Creme", "price": "79.00", "stock": 11},
                                {"color": "Salbei", "price": "79.00", "stock": 9},
                                {"color": "Terrakotta", "price": "79.00", "stock": 11},
                            ],
                        ),
                        _p(
                            "Kissenhülle „Grasnarbe“",
                            "34.00",
                            "Bezug aus dickem Leinen mit verdecktem Reißverschluss. Die Naht ist doppelt gekappt, damit sich der Stoff nicht verzieht.",
                            "kissen-grasnarbe-leinen",
                            sku="WT-KIS-503",
                            gtin="4261050000025",
                            material="100 % Leinen",
                            care="40 °C, feucht bügeln.",
                            stock=46,
                            variants=[
                                {
                                    "size": "40 × 40 cm",
                        ...
                        _p(
                            "Kissen „Bouclé“",
                            "49.00",
                            "Kissenhülle aus Bouclé-Gewebe mit spürbarer Schlaufenstruktur. Rückseite glatt, damit sie nicht auf dem Sofa rutscht.",
                            "kissen-boucle-schlaufe",
                            sku="WT-KIS-504",
                            gtin="4261050000032",
                            material="62 % Baumwolle, 38 % Polyester",
                        ...
                        _p(
                            "Bettwäsche „Halm“ Leinen",
                            "159.00",
                            "Bettwäsche aus vorgewaschenem Leinen, das mit jeder Wäsche weicher wird. Knopfleiste statt Reißverschluss.",
                            "bettwaesche-halm-leinen",
                            sku="WT-BET-505",
                            gtin="4261050000049",
                            material="100 % Leinen, Stone-washed",
                            care="60 °C möglich, Trockner niedrig.",
                            stock=12,
                            variants=[
                                {
                                    "size": "135 × 200 cm",
                ...
                (
                    ...
                    [
                        _p(
                            "Läufer „Sanddorn“",
                            "119.00",
                            "Flachgewebter Läufer aus Jute und Baumwolle für Flur und Küche. Kanten sind eingefasst, damit sie nicht ausfransen.",
                            "laeufer-sanddorn-jute",
                            sku="WT-TEP-506",
                            gtin="4261050000056",
                            material="70 % Jute, 30 % Baumwolle",
                            care="Absaugen, Flecken punktuell auswaschen.",
                            stock=15,
                            variants=[
                                {
                                    "size": "60 × 90 cm",
                        ...
                        _p(
                            "Teppich „Dünung“",
                            "349.00",
                            "Handgewebter Wollteppich mit unregelmäßiger Melierung, die Krümel und Alltag verzeiht. Rückseite ohne Latex.",
                            ["teppich-duenung-wolle", "teppich-duenung-raum"],
                            sku="WT-TEP-507",
                            gtin="4261050000063",
                            material="80 % Schurwolle, 20 % Baumwolle",
                            care="Fachreinigung empfohlen.",
                            stock=7,
                            variants=[
                                {
                                    "size": "140 × 200 cm",
                        ...
                        _p(
                            "Badvorleger „Tide“",
                            "39.00",
                            "Dicker Vorleger aus Baumwollchenille, der Wasser sofort aufnimmt und über Nacht trocknet.",
                            "badvorleger-tide-chenille",
                            sku="WT-TEP-508",
                            gtin="4261050000070",
                            material="100 % Baumwolle",
                            care="60 °C, Trockner möglich.",
                            stock=27,
                            variants=[
                                {
                                    "size": "50 × 80 cm",
                ...
                (
                    ...
                    [
                        _p(
                            "Duftkerze „Zeder & Salz“",
                            "32.00",
                            "Sojawachskerze im Steinzeuggefäß, Brenndauer rund 45 Stunden. Nach dem Abbrennen bleibt ein Becher übrig.",
                            "kerze-zeder-salz",
                            sku="WT-LIC-509",
                            gtin="4261050000087",
                            badge="neu",
                        ...
                        _p(
                            "Stumpenkerzen „Werktag“, 4er-Set",
                            "24.00",
                            "Vier ungefärbte Stumpenkerzen aus Rapswachs, rußarm und ohne Duft — für den Tisch, nicht für die Stimmungsmache.",
                            "stumpenkerzen-werktag-set",
                            sku="WT-LIC-510",
                            gtin="4261050000094",
                            stock=40,
                        ),
                        _p(
                            "Windlicht „Halm“ Glas",
                            "29.00",
                            "Mundgeblasenes Glas mit leicht welliger Wandung; jedes Stück ist etwas anders. Passt für Teelichter und kurze Stumpen.",
                            "windlicht-halm-glas",
                            sku="WT-LIC-511",
                            gtin="4261050000100",
                            stock=33,
                        ...
                        _p(
                            "Raumduft „Nordhang“",
                            "44.00",
                            "Diffusor mit Rattanstäbchen, Note aus Kiefer, Moos und Zitrus. Hält ohne Nachfüllen etwa drei Monate.",
                            "raumduft-nordhang-diffusor",
                            sku="WT-LIC-512",
                            gtin="4261050000117",
                            unit="l",
                            content="0.2",
                        ...
                        _p(
                            "Tischleuchte „Knick“",
                            "119.00",
                            "Kleine Leuchte aus pulverbeschichtetem Stahl mit geknicktem Arm, E14-Fassung. Kabel textilummantelt, 1,8 m.",
                            "tischleuchte-knick-stahl",
                            sku="WT-LIC-513",
                            gtin="4261050000124",
                            stock=14,
                            variants=[
                                {"color": "Anthrazit", "price": "119.00", "stock": 8},
                                {"color": "Creme", "price": "119.00", "stock": 6},
                            ],
                        ),
                    ],
                    "licht-duft-kerzen",
                ...
                (
                    ...
                    [
                        _p(
                            "Vase „Krug“ Steinzeug",
                            "54.00",
                            "Bauchige Vase aus Steinzeug mit matter Glasur innen und roher Oberfläche außen. Steht sicher, auch wenn sie voll ist.",
                            ["vase-krug-steinzeug", "vase-krug-blumen"],
                            sku="WT-VAS-514",
                            gtin="4261050000131",
                            material="Steinzeug, glasiert",
                            care="Von Hand spülen.",
                            stock=26,
                            variants=[
                                {
                                    "size": "klein (18 cm)",
                        ...
                        _p(
                            "Vase „Halm“ Glas",
                            "39.00",
                            "Schmale Glasvase für einzelne Zweige. Der schwere Boden verhindert, dass sie mit langen Stielen kippt.",
                            "vase-halm-glas",
                            sku="WT-VAS-515",
                            gtin="4261050000148",
                            stock=30,
                        ...
                        _p(
                            "Korb „Seegras“, groß",
                            "69.00",
                            "Geflochtener Korb mit verstärktem Rand für Decken oder Feuerholz. Die Griffe sind mit eingeflochten, nicht angenäht.",
                            "korb-seegras-gross",
                            sku="WT-VAS-516",
                            gtin="4261050000155",
                            material="Seegras, Baumwollkern",
                            stock=19,
                        ),
                        _p(
                            "Aufbewahrungsbox „Deckel“",
                            "42.00",
                            "Stapelbare Box aus fester Pappe mit Leinenbezug und Deckel. Innen unbeschichtet, damit nichts riecht.",
                            "box-deckel-leinen",
                            sku="WT-VAS-517",
                            gtin="4261050000162",
                            stock=23,
                            variants=[
                                {"color": "Ecru", "price": "42.00", "stock": 12},
                                {"color": "Anthrazit", "price": "42.00", "stock": 11},
                            ],
                        ),
                        _p(
                            "Bilderrahmen „Kante“ Eiche",
                            "36.00",
                            "Rahmen aus massiver Eiche mit schmalem Profil und entspiegeltem Glas. Zum Hängen und Stellen.",
                            "rahmen-kante-eiche",
                            sku="WT-VAS-518",
                            gtin="4261050000179",
                        ...
                        _p(
                            "Wandhaken „Reihe“, 3er",
                            "28.00",
                            "Drei Haken aus gebürstetem Messing auf einer Eichenleiste. Schrauben und Dübel liegen bei.",
                            "wandhaken-reihe-messing",
                            sku="WT-VAS-519",
                            gtin="4261050000186",
                            material="Messing, Eiche",
                            stock=0,
                        ),
                        _p(
                            "Spiegel „Rund“ 50 cm",
                            "139.00",
                            "Runder Spiegel mit schmalem Metallrahmen und rückseitiger Aufhängung in zwei Richtungen.",
                            "spiegel-rund-metall",
                            sku="WT-VAS-520",
                            gtin="4261050000193",
                            stock=4,
                            variants=[
                                {"color": "Schwarz", "price": "139.00", "stock": 2},
                                {"color": "Messing", "price": "149.00", "stock": 2},
                            ],
                        ),
                    ],
                    "vasen-koerbe-regal",
            ...
            "Decken, Kissen, Körbe und Licht für Räume, die man abends nicht mehr verlassen möchte. Textilien aus Naturfasern, Keramik aus kleinen Manufakturen.",
            "",
            "wohnen-textil-uebersicht",
        ),
        (
            "Küche & Tafel",
            "kueche-tafel",
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Teller „Scholle“ flach, 27 cm",
                            "18.00",
                            "Flacher Teller aus Steinzeug mit hochgezogenem Rand, der Sauce hält. Der unglasierte Fuß steht rutschfest auf Holz.",
                            ["teller-scholle-flach", "teller-scholle-gedeckt"],
                            sku="KT-GES-601",
                            gtin="4261060000000",
                            badge="beliebt",
                            material="Steinzeug, 1240 °C gebrannt",
                            care="Spülmaschine und Mikrowelle geeignet.",
                            stock=64,
                            variants=[
                                {"color": "Creme", "price": "18.00", "stock": 24},
                                {"color": "Salbei", "price": "18.00", "stock": 21},
                                {"color": "Anthrazit", "price": "18.00", "stock": 19},
                            ],
                        ),
                        _p(
                            "Suppenteller „Tief“",
                            "21.00",
                            "Tiefer Teller für Eintopf und Pasta, 700 ml. Stapelt sauber, ohne dass die Ränder aneinander schlagen.",
                            "teller-tief-suppe",
                            sku="KT-GES-602",
                            gtin="4261060000017",
                            material="Steinzeug",
                            ...
                            stock=48,
                            variants=[
                                {"color": "Creme", "price": "21.00", "stock": 25},
                                {"color": "Salbei", "price": "21.00", "stock": 23},
                            ],
                        ),
                        _p(
                            "Schale „Mulde“, 4er-Set",
                            "58.00",
                            "Vier Schalen für Müsli, Dip oder Beilagen. Innen glasiert, außen matt — angenehm in der Hand.",
                            "schale-mulde-set",
                            sku="KT-GES-603",
                            gtin="4261060000024",
                            material="Steinzeug",
                        ...
                        _p(
                            "Servierplatte „Lang“",
                            "44.00",
                            "Schmale Platte, 38 cm, für Brot, Käse oder Antipasti. Passt längs auf jeden Tisch, ohne Platz zu fressen.",
                            "servierplatte-lang-steinzeug",
                            sku="KT-GES-604",
                            gtin="4261060000031",
                            material="Steinzeug",
                            stock=17,
                ...
                (
                    ...
                    [
                        _p(
                            "Becher „Faust“ 350 ml",
                            "16.00",
                            "Schwerer Becher mit breitem Henkel, der auch mit Handschuhen greifbar ist. Hält Kaffee lange warm.",
                            "becher-faust-steinzeug",
                            sku="KT-BEC-605",
                            gtin="4261060000048",
                            material="Steinzeug",
                            care="Spülmaschinenfest.",
                            ...
                            stock=78,
                            variants=[
                                {"color": "Creme", "price": "16.00", "stock": 26},
                                {"color": "Terrakotta", "price": "16.00", "stock": 27},
                                {"color": "Petrol", "price": "16.00", "stock": 25},
                            ],
                        ),
                        _p(
                            "Espressotasse „Klein“, 2er",
                            "26.00",
                            "Zwei dickwandige Tassen à 80 ml. Die Wandstärke hält den Espresso auf Temperatur, ohne die Lippe zu verbrennen.",
                            "espressotasse-klein-paar",
                            sku="KT-BEC-606",
                            gtin="4261060000055",
                            material="Porzellan",
                            unit="ml",
                        ...
                        _p(
                            "Trinkglas „Rille“, 6er-Set",
                            "42.00",
                            "Sechs Gläser mit vertikaler Rillenstruktur, 300 ml, stapelbar. Aus recyceltem Glas, deshalb leicht grünstichig.",
                            "trinkglas-rille-set",
                            sku="KT-BEC-607",
                            gtin="4261060000062",
                            material="Recyceltes Kalk-Natron-Glas",
                            unit="ml",
                            content="300",
                            stock=29,
                        ),
                        _p(
                            "Karaffe „Hals“ 1 l",
                            "38.00",
                            "Karaffe mit schmalem Hals und Korkverschluss — steht auch über Nacht im Kühlschrank, ohne den Geruch anzunehmen.",
                            "karaffe-hals-glas",
                            sku="KT-BEC-608",
                            gtin="4261060000079",
                            unit="l",
                        ...
                        _p(
                            "Weinglas „Stiel“, 2er",
                            "34.00",
                            "Zwei Gläser mit gezogenem Stiel, 480 ml. Der Kelch ist dünnwandig, der Fuß bewusst schwer.",
                            "weinglas-stiel-paar",
                            sku="KT-BEC-609",
                            gtin="4261060000086",
                            unit="ml",
                ...
                (
                    ...
                    [
                        _p(
                            "Gusseisenpfanne „Feuer“ 26 cm",
                            "89.00",
                            "Vorgewürzte Pfanne aus Gusseisen ohne Kunststoffbeschichtung. Backofenfest bis 250 °C, Griff aus einem Stück gegossen.",
                            ["pfanne-feuer-gusseisen", "pfanne-feuer-herd"],
                            sku="KT-KOC-610",
                            gtin="4261060000093",
                            material="Gusseisen, eingebrannt",
                            care="Nicht in die Spülmaschine, heiß ausspülen und einölen.",
                            stock=26,
                            variants=[
                                {"size": "24 cm", "price": "79.00", "stock": 12},
                                {"size": "26 cm", "price": "89.00", "stock": 14},
                            ],
                        ),
                        _p(
                            "Bräter „Sonntag“ 4,5 l",
                            "179.00",
                            "Emaillierter Gusseisenbräter mit schwerem Deckel, der Feuchtigkeit im Topf hält. Für Ofen und Herd, auch Induktion.",
                            "braeter-sonntag-emaille",
                            sku="KT-KOC-611",
                            gtin="4261060000109",
                            material="Gusseisen, emailliert",
                            stock=11,
                            variants=[
                                {"color": "Rostrot", "price": "179.00", "stock": 6},
                                {"color": "Anthrazit", "price": "179.00", "stock": 5},
                            ],
                        ),
                        _p(
                            "Topf „Alltag“ 2,5 l",
                            "99.00",
                            "Edelstahltopf mit Sandwichboden und Maßskala innen. Der Deckel sitzt satt, ohne zu klemmen.",
                            "topf-alltag-edelstahl",
                            sku="KT-KOC-612",
                            gtin="4261060000116",
                        ...
                        _p(
                            "Küchenmesser „Kante“ 20 cm",
                            "119.00",
                            "Kochmesser aus rostfreiem Klingenstahl mit Griff aus geölter Walnuss. Die Klinge ist beidseitig geschliffen.",
                            "messer-kante-koch",
                            sku="KT-KOC-613",
                            gtin="4261060000123",
                            material="Klingenstahl X50CrMoV15, Walnuss",
                            care="Nur von Hand spülen, sofort abtrocknen.",
                            stock=15,
                        ),
                    ],
                    "kochen-braten-pfanne",
                ),
                (
                    "Holz & Besteck",
                    "holz-besteck",
                    [
                        _p(
                            "Schneidebrett „Scheibe“ Eiche",
                            "64.00",
                            "Brett aus stirnholzverleimter Eiche, 40 × 28 cm, mit umlaufender Saftrille. Schont die Klinge spürbar.",
                            "brett-scheibe-eiche",
                            sku="KT-HOL-614",
                            gtin="4261060000130",
                            material="Eiche, lebensmittelecht geölt",
                            care="Von Hand spülen, gelegentlich mit Öl pflegen.",
                            stock=24,
                            variants=[
                                {"size": "30 × 20 cm", "price": "44.00", "stock": 12},
                                {"size": "40 × 28 cm", "price": "64.00", "stock": 12},
                            ],
                        ),
                        _p(
                            "Kochlöffel-Set „Drei“",
                            "29.00",
                            "Drei Löffel aus Olivenholz — gerade, geschlitzt und spitz. Kratzt keine Beschichtung an.",
                            "loeffel-drei-olivenholz",
                            sku="KT-HOL-615",
                            gtin="4261060000147",
                            material="Olivenholz",
                            stock=41,
                        ...
                        _p(
                            "Besteck „Gerade“, 16-teilig",
                            "129.00",
                            "Besteck für vier Gedecke aus mattiertem Edelstahl. Die Griffe sind gleich breit wie die Laffe — ruhige Linie auf dem Tisch.",
                            "besteck-gerade-edelstahl",
                            sku="KT-HOL-616",
                            gtin="4261060000154",
                            material="Edelstahl 18/10",
                            care="Spülmaschinenfest.",
                        ...
                        _p(
                            "Schüssel „Mulde“ Olivenholz",
                            "72.00",
                            "Aus einem Stück gedrechselte Schüssel; jede Maserung ist anders. Für Salat, Obst oder Schlüssel im Flur.",
                            "schuessel-mulde-holz",
                            sku="KT-HOL-617",
                            gtin="4261060000161",
                            material="Olivenholz",
                            care="Nicht einweichen, mit Öl nachpflegen.",
                            stock=9,
                        ),
                        _p(
                            "Geschirrtuch „Streifen“, 3er",
                            "27.00",
                            "Drei Halbleinen-Tücher, gewaschen und deshalb sofort saugfähig — nicht erst nach zehn Wäschen.",
                            "geschirrtuch-streifen-set",
                            sku="KT-HOL-618",
                            gtin="4261060000178",
                            ...
                            stock=55,
                            variants=[
                                {"color": "Nachtblau", "price": "27.00", "stock": 28},
                                {"color": "Rostrot", "price": "27.00", "stock": 27},
                            ],
                        ),
                        _p(
                            "Vorratsglas „Bügel“ 1 l",
                            "14.00",
                            "Bügelglas mit austauschbarem Gummiring. Der Deckel schließt dicht genug für Mehl, Nudeln und offene Kekspackungen.",
                            "vorratsglas-buegel-liter",
                            sku="KT-HOL-619",
                            gtin="4261060000185",
                            unit="l",
                            content="1",
                        ...
                        _p(
                            "Brotkasten „Laib“ Emaille",
                            "89.00",
                            "Emaillierter Kasten mit Lüftungsschlitzen und Holzdeckel, der als Schneidebrett dient. Brot bleibt zwei Tage länger frisch.",
                            "brotkasten-laib-emaille",
                            sku="KT-HOL-620",
                            gtin="4261060000192",
                            badge="neu",
                            material="Stahl, emailliert; Eschendeckel",
                            stock=8,
                        ),
                    ],
                    "holz-besteck-brett",
            ...
            "Geschirr, Schneidebretter und Pfannen, die man täglich benutzt und nicht schont. Steinzeug aus Portugal, Holz aus europäischer Eiche, Gusseisen ohne Beschichtung.",
            "",
            "kueche-tafel-uebersicht",
        ),
        (
            "Kaffee & Tee",
            "kaffee-tee",
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Filterkaffee „Morgenlicht“",
                            "13.90",
                            "Helle Röstung aus Äthiopien mit klarer Säure und einer Note von schwarzem Tee. Für Filter und Karlsbader Kanne.",
                            ["kaffee-morgenlicht-filter", "kaffee-morgenlicht-tasse"],
                            sku="KF-KAF-701",
                            gtin="4261070000009",
                            badge="beliebt",
                            origin="Äthiopien",
                            ...
                            stock=58,
                            variants=[
                                {"size": "250 g", "price": "13.90", "stock": 26},
                                {"size": "500 g", "price": "24.90", "stock": 20},
                                {"size": "1 kg", "price": "44.90", "stock": 12},
                            ],
                        ),
                        _p(
                            "Espresso „Werkbank“",
                            "15.90",
                            "Dunklere Röstung aus Brasilien und Indien, kräftig und schokoladig — hält sich auch in Milch.",
                            "kaffee-werkbank-espresso",
                            sku="KF-KAF-702",
                            gtin="4261070000016",
                            ...
                            stock=44,
                            variants=[
                                {"size": "250 g", "price": "15.90", "stock": 18},
                                {"size": "1 kg", "price": "52.90", "stock": 26},
                            ],
                        ),
                        _p(
                            "Entkoffeiniert „Abendrot“",
                            "16.90",
                            "Schonend mit Wasser entkoffeiniert, deshalb bleibt der Körper erhalten. Röstgrad zwischen Filter und Espresso.",
                            "kaffee-abendrot-entkoffeiniert",
                            sku="KF-KAF-703",
                            gtin="4261070000023",
                            origin="Kolumbien",
                            unit="kg",
                        ...
                        _p(
                            ...
                            "12.50",
                            "Zwölf Stunden kalt extrahiert, ungesüßt. Ein Teil Konzentrat auf drei Teile Wasser oder Milch.",
                            "kaffee-coldbrew-flasche",
                            sku="KF-KAF-704",
                            gtin="4261070000030",
                            unit="l",
                            content="0.5",
                        ...
                        _p(
                            "Probierpaket Kaffee, 3 × 100 g",
                            "19.90",
                            "Drei aktuelle Röstungen in kleinen Tüten — zum Vergleichen, bevor man ein Kilo kauft.",
                            "kaffee-probierpaket-drei",
                            sku="KF-KAF-705",
                            gtin="4261070000047",
                            unit="kg",
                            content="0.3",
                ...
                (
                    ...
                    [
                        _p(
                            "Schwarztee „Zweite Ernte“",
                            "11.90",
                            "Darjeeling der zweiten Pflückung, muskatig und ohne Bitterkeit, auch wenn er einmal zu lange zieht.",
                            "tee-zweite-ernte-darjeeling",
                            sku="KF-TEE-706",
                            gtin="4261070000054",
                            origin="Indien, Darjeeling",
                            unit="kg",
                            content="0.1",
                            stock=39,
                            variants=[
                                {"size": "100 g", "price": "11.90", "stock": 22},
                                {"size": "250 g", "price": "26.90", "stock": 17},
                            ],
                        ),
                        _p(
                            "Grüntee „Nebel“",
                            "14.90",
                            "Japanischer Sencha aus Beschattung, grasig und rund. Bei 70 °C aufgießen, sonst wird er streng.",
                            "tee-nebel-sencha",
                            sku="KF-TEE-707",
                            gtin="4261070000061",
                            origin="Japan",
                        ...
                        _p(
                            "Kräutertee „Feldrand“",
                            "9.90",
                            "Mischung aus Melisse, Pfefferminze und Ringelblume aus deutschem Anbau. Koffeinfrei, auch abends.",
                            "tee-feldrand-kraeuter",
                            sku="KF-TEE-708",
                            gtin="4261070000078",
                            origin="Deutschland",
                            unit="kg",
                        ...
                        _p(
                            "Rooibos „Ofenwärme“",
                            "10.90",
                            "Rooibos mit Zimt, Orangenschale und Vanille — der Tee, der im Advent alle drei Tage neu aufgesetzt wird.",
                            "tee-ofenwaerme-rooibos",
                            sku="KF-TEE-709",
                            gtin="4261070000085",
                            origin="Südafrika",
                            unit="kg",
                ...
                (
                    ...
                    [
                        _p(
                            "Teekanne „Bauch“ 1,2 l",
                            "59.00",
                            "Steinzeugkanne mit herausnehmbarem Edelstahlsieb. Der Deckel bleibt beim Eingießen liegen.",
                            "teekanne-bauch-steinzeug",
                            sku="KF-ZUB-710",
                            gtin="4261070000092",
                            material="Steinzeug, Edelstahlsieb",
                            unit="l",
                            content="1.2",
                            stock=16,
                        ),
                        _p(
                            "French Press „Klar“ 0,8 l",
                            "49.00",
                            "Borosilikatglas im Edelstahlrahmen, Sieb dreiteilig und komplett zerlegbar zum Reinigen.",
                            "pressstempel-klar-glas",
                            sku="KF-ZUB-711",
                            gtin="4261070000108",
                        ...
                        _p(
                            "Handmühle „Kurbel“",
                            "89.00",
                            "Kegelmahlwerk aus Keramik mit 30 Rastungen von Espresso bis French Press. Passt in die Kanne einer Reisekaffeemaschine.",
                            ["muehle-kurbel-hand", "muehle-kurbel-mahlgut"],
                            sku="KF-ZUB-712",
                            gtin="4261070000115",
                            badge="neu",
                            material="Edelstahl, Keramikmahlwerk",
                            stock=14,
                        ),
                        _p(
                            "Handfilter „Kegel“ Keramik",
                            "34.00",
                            "Kegelfilter mit einer breiten Rille, damit Luft entweichen kann. Für Filtergröße 02.",
                            "handfilter-kegel-keramik",
                            sku="KF-ZUB-713",
                            gtin="4261070000122",
                            material="Keramik",
                        ...
                        _p(
                            "Thermobecher „Weg“ 0,4 l",
                            "36.00",
                            "Doppelwandiger Becher aus Edelstahl mit Drehverschluss, der auch quer in der Tasche dicht bleibt.",
                            "thermobecher-weg-stahl",
                            sku="KF-ZUB-714",
                            gtin="4261070000139",
                            ...
                            variants=[
                                ...
                                {"size": "0,4 l", "color": "Salbei", "price": "36.00", "stock": 14},
                                {"size": "0,4 l", "color": "Creme", "price": "36.00", "stock": 13},
                            ],
                        ),
                        _p(
                            "Milchkännchen „Guss“ 0,35 l",
                            "29.00",
                            "Kännchen aus Edelstahl mit scharf gezogener Tülle — Voraussetzung für halbwegs saubere Latte-Art.",
                            "milchkaennchen-guss-stahl",
                            sku="KF-ZUB-715",
                            gtin="4261070000146",
                            material="Edelstahl",
                            unit="l",
                ...
                (
                    ...
                    [
                        _p(
                            ...
                            "4.90",
                            "Tafel aus kolumbianischem Kakao, ohne Lecithin, mit deutlicher Fruchtnote.",
                        ...
                        _p(
                            "Milchschokolade „Weide“ 45 %",
                            "4.90",
                            "Vollmilchschokolade mit Alpenmilch, weniger süß als üblich, weil der Kakaoanteil höher liegt.",
                            "schokolade-weide-milch",
                            sku="KF-SUE-717",
                            gtin="4261070000160",
                            origin="Schweiz",
                            unit="kg",
                        ...
                        _p(
                            "Kakao „Winter“ Trinkschokolade",
                            "12.90",
                            "Geraspelte Schokolade zum Aufgießen statt Kakaopulver — löst sich in heißer Milch vollständig.",
                            "kakao-winter-raspel",
                            sku="KF-SUE-718",
                            gtin="4261070000177",
                            unit="kg",
                        ...
                        _p(
                            "Karamellen „Salzflor“, 150 g",
                            "8.90",
                            "Weiche Karamellbonbons mit Meersalz, einzeln in Pergament gewickelt. Kleben nicht am Papier.",
                            "karamellen-salzflor-dose",
                            sku="KF-SUE-719",
                            gtin="4261070000184",
                            unit="kg",
                            content="0.15",
                        ...
                        _p(
                            "Honig „Lindenblüte“, 500 g",
                            "13.50",
                            "Cremig gerührter Lindenblütenhonig eines Imkers aus dem Bergischen Land. Ernte des laufenden Jahres.",
                            "honig-lindenbluete-glas",
                            sku="KF-SUE-720",
                            gtin="4261070000191",
                            origin="Deutschland, Bergisches Land",
                            unit="kg",
                            content="0.5",
                            stock=6,
                        ),
                    ],
                    "suesses-schokolade-tafel",
                ),
            ],
            "Bohnen aus kleinen Röstereien, loser Tee aus einzelnen Gärten und das Gerät dazu. Röstdatum steht auf jeder Packung, nicht nur das Haltbarkeitsdatum.",
            "",
            "kaffee-tee-uebersicht",
        ),
        (
            "Pflege & Bad",
            "pflege-bad",
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Seife „Salzluft“",
                            "8.90",
                            "Kaltgerührte Seife mit Meersalz und Sheabutter, ohne Palmöl. Der Schaum ist fein, der Riegel hält gut zwei Monate.",
                            "seife-salzluft-stueck",
                            sku="PB-SEI-801",
                            gtin="4261080000008",
                            badge="beliebt",
                            unit="kg",
                        ...
                        _p(
                            "Seife „Kohle & Minze“",
                            "8.90",
                            "Dunkle Seife mit Aktivkohle und Pfefferminzöl — für Hände nach Garten- oder Werkstattarbeit.",
                            "seife-kohle-minze",
                            sku="PB-SEI-802",
                            gtin="4261080000015",
                            unit="kg",
                        ...
                        _p(
                            "Festes Shampoo „Regen“",
                            "11.90",
                            "Shampoo-Stück für normales Haar, silikonfrei, ohne SLS. Ersetzt etwa zwei Flaschen Flüssigshampoo.",
                            "shampoo-regen-fest",
                            sku="PB-SEI-803",
                            gtin="4261080000022",
                            unit="kg",
                        ...
                        _p(
                            "Duschgel „Zeder“, Nachfüller",
                            "16.90",
                            "Nachfüllbeutel mit 500 ml, aus dem eine Pumpflasche zweimal gefüllt wird. Duft aus Zedernholz und Vetiver.",
                            "duschgel-zeder-nachfuell",
                            sku="PB-SEI-804",
                            gtin="4261080000039",
                            unit="l",
                            content="0.5",
                        ...
                        _p(
                            "Seifenschale „Rippe“ Eiche",
                            "18.00",
                            "Schale mit Längsrillen, damit die Seife abtrocknet und nicht schmiert. Aus geölter Eiche.",
                            "seifenschale-rippe-eiche",
                            sku="PB-SEI-805",
                            gtin="4261080000046",
                            material="Eiche, geölt",
                ...
                (
                    ...
                    [
                        _p(
                            "Gesichtsöl „Nachtwache“",
                            "38.00",
                            "Leichtes Öl aus Jojoba, Nachtkerze und Hagebutte für abends. Zieht ein, ohne das Kissen zu markieren.",
                            ["gesichtsoel-nachtwache-pipette", "gesichtsoel-nachtwache-tropfen"],
                            sku="PB-GES-806",
                            gtin="4261080000053",
                            unit="l",
                            content="0.03",
                        ...
                        _p(
                            "Handcreme „Werktag“",
                            "14.90",
                            "Reichhaltige Creme mit Bienenwachs für Hände, die oft gewaschen werden. Zieht in einer Minute ein.",
                            "handcreme-werktag-tube",
                            sku="PB-GES-807",
                            gtin="4261080000060",
                            unit="l",
                            content="0.075",
                        ...
                        _p(
                            "Körperlotion „Leinen“",
                            "22.90",
                            "Leichte Lotion mit Hafer und Mandelöl, ohne Parfüm. Für trockene Haut nach dem Duschen.",
                            "koerperlotion-leinen-flasche",
                            sku="PB-GES-808",
                            gtin="4261080000077",
                            unit="l",
                            content="0.2",
                        ...
                        _p(
                            "Lippenbalsam „Winter“, 2er",
                            "12.90",
                            "Zwei Dosen mit Sheabutter und Ringelblume — eine für die Tasche, eine für den Nachttisch.",
                            "lippenbalsam-winter-dose",
                            sku="PB-GES-809",
                            gtin="4261080000084",
                            unit="kg",
                            content="0.03",
                        ...
                        _p(
                            "Bartöl „Kiefer“",
                            "26.00",
                            "Öl aus Traubenkern und Argan mit Kiefernnadel, mattierend statt glänzend.",
                            "bartoel-kiefer-flakon",
                            sku="PB-GES-810",
                            gtin="4261080000091",
                            unit="l",
                            content="0.05",
                        ...
                        _p(
                            "Duft „Nordwind“ Eau de Parfum",
                            "89.00",
                            "Holzig-frischer Duft mit Wacholder, Salz und Zeder. 12 % Duftölanteil, deshalb hält er den Tag.",
                            "duft-nordwind-flakon",
                            sku="PB-GES-811",
                            gtin="4261080000107",
                            unit="l",
                            content="0.05",
                ...
                (
                    ...
                    [
                        _p(
                            "Haarbürste „Ahorn“",
                            "29.00",
                            "Bürste mit Holzstiften auf Kautschukkissen, Griff aus geöltem Ahorn. Zieht nicht am Ansatz.",
                            "haarbuerste-ahorn-holz",
                            sku="PB-BUE-812",
                            gtin="4261080000114",
                            material="Ahorn, Naturkautschuk",
                            stock=32,
                        ),
                        _p(
                            "Körperbürste „Trocken“",
                            "24.00",
                            "Bürste aus Sisal mit abnehmbarer Schlaufe, für die Trockenmassage vor dem Duschen.",
                            "koerperbuerste-trocken-sisal",
                            sku="PB-BUE-813",
                            gtin="4261080000121",
                            material="Buche, Sisal",
                            stock=25,
                        ),
                        _p(
                            "Rasierhobel „Kante“",
                            "59.00",
                            "Geschlossener Hobel aus verchromtem Messing, Gewicht 98 g. Fünf Klingen liegen bei.",
                            "rasierhobel-kante-messing",
                            sku="PB-BUE-814",
                            gtin="4261080000138",
                        ...
                        _p(
                            "Zahnbürste „Halm“, 4er",
                            "16.90",
                            "Vier Bürsten mit Bambusgriff und weichen Borsten, farbig markiert für den Familienbecher.",
                            "zahnbuerste-halm-bambus",
                            sku="PB-BUE-815",
                            gtin="4261080000145",
                            material="Bambus, Nylonborsten",
                            stock=49,
                        ),
                        _p(
                            "Kulturbeutel „Reise“",
                            "54.00",
                            "Beutel aus gewachstem Canvas mit wasserfestem Innenfutter und Haken zum Aufhängen.",
                            "kulturbeutel-reise-canvas",
                            sku="PB-BUE-816",
                            gtin="4261080000152",
                            material="Gewachstes Baumwoll-Canvas",
                            stock=20,
                            variants=[
                                {"color": "Oliv", "price": "54.00", "stock": 11},
                                {"color": "Anthrazit", "price": "54.00", "stock": 9},
                            ],
                        ),
                    ],
                    "buersten-zubehoer-holz",
                ),
                (
                    "Handtücher",
                    "handtuecher",
                    [
                        _p(
                            "Handtuch „Frottee“ 50 × 100",
                            "26.00",
                            "Handtuch aus Zwirnfrottee, 550 g/m². Saugt sofort und wird auch nach vielen Wäschen nicht hart.",
                            "handtuch-frottee-hand",
                            sku="PB-HAN-817",
                            gtin="4261080000169",
                            material="100 % Baumwolle, 550 g/m²",
                            care="60 °C, ohne Weichspüler.",
                            stock=66,
                            variants=[
                                {
                                    "size": "50 × 100 cm",
                        ...
                        _p(
                            "Duschtuch „Frottee“ 70 × 140",
                            "42.00",
                            "Großes Tuch derselben Serie. Die Webkante ist doppelt gesäumt, damit sie nicht einrollt.",
                            "duschtuch-frottee-gross",
                            sku="PB-HAN-818",
                            gtin="4261080000176",
                            material="100 % Baumwolle, 550 g/m²",
                            care="60 °C, ohne Weichspüler.",
                        ...
                        _p(
                            "Gästetuch „Waffel“, 2er",
                            "22.00",
                            "Zwei leichte Waffelpiqué-Tücher, die schnell trocknen — für das Gästebad, wo nichts hängen bleiben soll.",
                            "gaestetuch-waffel-paar",
                            sku="PB-HAN-819",
                            gtin="4261080000183",
                            material="100 % Baumwolle",
                            stock=37,
                        ...
                        _p(
                            "Bademantel „Morgen“",
                            "119.00",
                            "Leichter Mantel aus Waffelpiqué mit Schalkragen und zwei Taschen, ohne wattierte Schulter.",
                            "bademantel-morgen-waffel",
                            sku="PB-HAN-820",
                            gtin="4261080000190",
                            material="100 % Baumwolle",
                            care="60 °C.",
                            stock=13,
                            variants=[
                                {"size": "S/M", "color": "Creme", "price": "119.00", "stock": 5},
                                {"size": "L/XL", "color": "Creme", "price": "119.00", "stock": 4},
                                {
                                    "size": "S/M",
                                    "color": "Anthrazit",
                                    "price": "119.00",
                    ...
                    "handtuecher-stapel-frottee",
                ),
            ],
            "Seifen, Öle und Bürsten ohne Mikroplastik und ohne Versprechen, die kein Kosmetikum halten kann. Volle INCI auf jeder Packung.",
            "",
            "pflege-bad-uebersicht",
        ),
        (
            "Papeterie & Büro",
            "papeterie-buero",
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Notizbuch „Leinen“ A5",
                            "24.00",
                            "Fadengeheftetes Buch mit 192 Seiten 100-g-Papier, das auch Füller aushält. Liegt flach auf.",
                            ["notizbuch-leinen-a5", "notizbuch-leinen-aufgeschlagen"],
                            sku="PA-NOT-901",
                            gtin="4261090000007",
                            badge="beliebt",
                            material="Leinenbezug, 100 g/m² Papier",
                            stock=58,
                            variants=[
                                {
                                    "size": "A5 blanko",
                        ...
                        _p(
                            "Notizbuch „Leinen“ A6",
                            "16.00",
                            "Dasselbe Papier im Taschenformat, 144 Seiten, mit Gummiband und Lesezeichen.",
                            "notizbuch-taschen-a6",
                            sku="PA-NOT-902",
                            gtin="4261090000014",
                            stock=63,
                            variants=[
                        ...
                        _p(
                            "Skizzenbuch „Grau“ A4",
                            "29.00",
                            "Buch mit 120 g starkem Naturpapier für Bleistift und Kohle, quer aufklappbar.",
                            "skizzenbuch-grau-a4",
                            sku="PA-NOT-903",
                            gtin="4261090000021",
                            stock=24,
                        ...
                        _p(
                            "Heftchen „Dreier“, A6",
                            "12.00",
                            "Drei dünne Hefte à 32 Seiten für Notizen, die nicht bleiben müssen. Recyclingpapier, blanko.",
                            "heftchen-dreier-a6",
                            sku="PA-NOT-904",
                            gtin="4261090000038",
                            stock=52,
                ...
                (
                    ...
                    [
                        _p(
                            "Füller „Halm“",
                            "79.00",
                            "Kolbenfüller mit Iridiumfeder in M, Korpus aus Acryl. Tinte kommt aus dem Glas, nicht aus der Patrone.",
                            "fueller-halm-kolben",
                            sku="PA-SCH-905",
                            gtin="4261090000045",
                            material="Acryl, Stahlfeder",
                            stock=19,
                            variants=[
                                {
                                    "size": "Feder M",
                        ...
                        _p(
                            "Tinte „Nachtblau“, 50 ml",
                            "14.00",
                            "Dokumentenechte Tinte im Glas mit breitem Boden, das beim Füllen nicht umkippt.",
                            "tinte-nachtblau-glas",
                            sku="PA-SCH-906",
                            gtin="4261090000052",
                            unit="l",
                            content="0.05",
                        ...
                        _p(
                            ...
                            "34.00",
                            "Schwerer Stift aus massivem Messing, der mit den Jahren Patina ansetzt. Standardmine D1.",
                            "kugelschreiber-messing-stift",
                            sku="PA-SCH-907",
                            gtin="4261090000069",
                            material="Messing, unbeschichtet",
                            stock=27,
                        ),
                        _p(
                            "Bleistift-Set „Werkbank“, 6er",
                            "15.00",
                            "Sechs Bleistifte HB bis 6B aus Zedernholz, unlackiert, mit Prägung statt Aufdruck.",
                            "bleistift-werkbank-set",
                            sku="PA-SCH-908",
                            gtin="4261090000076",
                            stock=61,
                        ),
                        _p(
                            "Fineliner „Linie“, 4er",
                            "18.00",
                            "Vier Stärken von 0,2 bis 0,8 mm mit pigmentierter Tinte, wischfest und nachfüllbar.",
                            "fineliner-linie-set",
                            sku="PA-SCH-909",
                            gtin="4261090000083",
                            stock=45,
                        ...
                        _p(
                            "Radierer & Spitzer „Paar“",
                            "11.00",
                            "Metallspitzer mit Auffangdose und ein Radierer, der nicht bröselt.",
                            "radierer-spitzer-paar",
                            sku="PA-SCH-910",
                            gtin="4261090000090",
                            stock=3,
                ...
                (
                    ...
                    [
                        _p(
                            "Wandkalender 2027 „Jahr“",
                            "32.00",
                            "Ein Jahr auf einem Bogen, 50 × 70 cm, mit Feiertagen und Kalenderwochen. Auf 170-g-Papier gedruckt.",
                            "wandkalender-jahr-bogen",
                            sku="PA-KAL-911",
                            gtin="4261090000106",
                            badge="neu",
                            stock=36,
                        ...
                        _p(
                            "Wochenplaner „Kante“ A5",
                            "26.00",
                            "Undatierter Planer für 52 Wochen — beginnt an dem Montag, an dem man ihn aufschlägt.",
                            "wochenplaner-kante-a5",
                            sku="PA-KAL-912",
                            gtin="4261090000113",
                            stock=33,
                        ...
                        _p(
                            "Tischkalender „Woche“",
                            "22.00",
                            "Aufsteller mit einer Woche pro Blatt, Rückseite blanko für Notizen. Ohne Werbung.",
                            "tischkalender-woche-aufsteller",
                            sku="PA-KAL-913",
                            gtin="4261090000120",
                            stock=28,
                        ),
                        _p(
                            "Postkarten „Küste“, 10er",
                            "14.00",
                            "Zehn Motive auf Büttenkarton, blanko auf der Rückseite. Passen in Standardumschläge.",
                            "postkarten-kueste-set",
                            sku="PA-KAL-914",
                            gtin="4261090000137",
                            stock=54,
                        ),
                        _p(
                            "Geschenkpapier „Bogen“, 3er",
                            "12.00",
                            "Drei Bogen 70 × 100 cm aus ungebleichtem Papier, einfarbig bedruckt und kompostierbar.",
                            "geschenkpapier-bogen-drei",
                            sku="PA-KAL-915",
                            gtin="4261090000144",
                            stock=47,
                        ),
                    ],
                    "kalender-planer-wand",
                ),
                (
                    "Ordnung",
                    "ordnung",
                    [
                        _p(
                            "Ablage „Stapel“ Eiche",
                            "58.00",
                            "Zwei stapelbare Fächer aus Eiche für A4. Die Kanten sind gefast, damit Papier nicht hängen bleibt.",
                            "ablage-stapel-eiche",
                            sku="PA-ORD-916",
                            gtin="4261090000151",
                            material="Eiche, geölt",
                        ...
                        _p(
                            "Stiftebecher „Rohr“ Messing",
                            "26.00",
                            "Becher aus gebürstetem Messing mit Filzboden, der den Tisch nicht zerkratzt.",
                            "stiftebecher-rohr-messing",
                            sku="PA-ORD-917",
                            gtin="4261090000168",
                            material="Messing",
                        ...
                        _p(
                            "Dokumentenmappe „Klapp“ A4",
                            "48.00",
                            "Mappe aus pflanzlich gegerbtem Leder mit Gummizug, fasst rund 40 Blatt.",
                            "mappe-klapp-leder",
                            sku="PA-ORD-918",
                            gtin="4261090000175",
                            ...
                            stock=14,
                            variants=[
                                {"size": "A4", "color": "Cognac", "price": "48.00", "stock": 8},
                                {"size": "A4", "color": "Schwarz", "price": "48.00", "stock": 6},
                            ],
                        ),
                        _p(
                            "Ordner „Rücken“ A4, 2er",
                            "24.00",
                            "Zwei Ordner aus Graupappe mit Leinenrücken und beschriftbarem Schild.",
                            "ordner-ruecken-paar",
                            sku="PA-ORD-919",
                            gtin="4261090000182",
                            stock=38,
                        ...
                        _p(
                            "Stempel „Datum“ Holz",
                            "34.00",
                            "Datumsstempel mit Holzgriff, Jahresrädchen bis 2032. Kissen liegt bei.",
                            "stempel-datum-holz",
                            sku="PA-ORD-920",
                            gtin="4261090000199",
                            stock=0,
                    ...
                    "ordnung-ablage-schreibtisch",
                ),
            ],
            "Papier, das Tinte nicht durchschlägt, und Stifte, die man nachfüllt statt wegwirft. Alles auf einem Schreibtisch abgestimmt.",
            "",
            "papeterie-buero-uebersicht",
        ),
        (
            "Sport & Outdoor",
            "sport-outdoor",
            ...
            [
                (
                    ...
                    [
                        _p(
                            "Trinkflasche „Quelle“ 0,75 l",
                            "32.00",
                            "Einwandige Edelstahlflasche mit weiter Öffnung für Eiswürfel. Ohne Innenbeschichtung, deshalb geschmacksneutral.",
                            "flasche-quelle-stahl",
                            sku="SO-TRI-1001",
                            gtin="4261100000004",
                            badge="beliebt",
                            ...
                            variants=[
                                ...
                                {"size": "0,75 l", "color": "Creme", "price": "32.00", "stock": 18},
                            ],
                        ),
                        _p(
                            "Isolierflasche „Kalt & Heiß“ 0,5 l",
                            "42.00",
                            "Doppelwandig, hält 12 Stunden warm und 24 kalt. Der Verschluss lässt sich einhändig öffnen.",
                            "isolierflasche-doppelwand-halb",
                            sku="SO-TRI-1002",
                            gtin="4261100000011",
                        ...
                        _p(
                            "Thermoskanne „Lager“ 1 l",
                            "59.00",
                            "Kanne mit Drehverschluss und Becher als Deckel — für die Pause auf dem Berg, nicht für den Schreibtisch.",
                            "thermoskanne-lager-liter",
                            sku="SO-TRI-1003",
                            gtin="4261100000028",
                            unit="l",
                            content="1",
                        ...
                        _p(
                            "Brotdose „Deckel“ Edelstahl",
                            "34.00",
                            "Auslaufsichere Dose mit Klammern und herausnehmbarem Trenner, 1,2 l. Ohne Kunststoffdichtung im Deckel.",
                            "brotdose-deckel-stahl",
                            sku="SO-TRI-1004",
                            gtin="4261100000035",
                            material="Edelstahl, Silikondichtung",
                            unit="l",
                            content="1.2",
                            stock=30,
                        ),
                        _p(
                            "Campingbesteck „Falt“",
                            "22.00",
                            "Löffel, Gabel und Messer aus Titan, zusammen 58 g, an einem Karabinerring.",
                            "campingbesteck-falt-titan",
                            sku="SO-TRI-1005",
                            gtin="4261100000042",
                            material="Titan",
                            stock=44,
                ...
                (
                    ...
                    [
                        _p(
                            "Yogamatte „Grund“ 4 mm",
                            "69.00",
                            "Matte aus Naturkautschuk mit rauer Oberfläche, die auch bei feuchten Händen greift. Ohne PVC.",
                            ["yogamatte-grund-kautschuk", "yogamatte-grund-uebung"],
                            sku="SO-YOG-1006",
                            gtin="4261100000059",
                            material="Naturkautschuk, Baumwollflor",
                            care="Feucht abwischen, nicht in die Sonne legen.",
                            stock=28,
                            variants=[
                                {
                                    "size": "183 × 61 cm",
                        ...
                        _p(
                            "Yogablock „Kork“, 2er",
                            "38.00",
                            "Zwei Blöcke aus gepresstem Kork, rutschfest und formstabil, auch wenn man sich draufstellt.",
                            "yogablock-kork-paar",
                            sku="SO-YOG-1007",
                            gtin="4261100000066",
                            material="Presskork",
                        ...
                        _p(
                            "Yogagurt „Band“ 2,5 m",
                            "18.00",
                            "Gurt aus Baumwolle mit D-Ring-Schnalle, die unter Zug hält und sich trotzdem lösen lässt.",
                            "yogagurt-band-baumwolle",
                            sku="SO-YOG-1008",
                            gtin="4261100000073",
                            material="Baumwolle, Stahlschnalle",
                            stock=39,
                        ),
                        _p(
                            "Faszienrolle „Welle“",
                            "34.00",
                            "Rolle mit strukturierter Oberfläche, mittelhart. Der Kern ist hohl, dadurch nur 480 g.",
                            "faszienrolle-welle-schaum",
                            sku="SO-YOG-1009",
                            gtin="4261100000080",
                            stock=26,
                        ),
                        _p(
                            "Sporthandtuch „Schnell“",
                            "24.00",
                            "Mikrofasertuch 80 × 130 cm, trocknet in einer Stunde und riecht dank Silberionen nicht.",
                            "sporthandtuch-schnell-mikro",
                            sku="SO-YOG-1010",
                            gtin="4261100000097",
                ...
                (
                    ...
                    [
                        _p(
                            "Wanderrucksack „Grat“ 28 l",
                            "149.00",
                            "Rucksack mit belüftetem Rücken, Hüftgurt und Regenhülle im Bodenfach. Nähte am Trägeransatz verstärkt.",
                            ["rucksack-grat-wandern", "rucksack-grat-tour"],
                            sku="SO-RUC-1011",
                            gtin="4261100000103",
                            material="Recyceltes Polyamid 210D",
                            stock=18,
                            variants=[
                                {"size": "28 l", "color": "Oliv", "price": "149.00", "stock": 7},
                                {
                                    "size": "28 l",
                                    "color": "Anthrazit",
                                    "price": "149.00",
                        ...
                        _p(
                            "Tagesrucksack „Pfad“ 18 l",
                            "99.00",
                            "Leichter Rucksack mit gepolstertem Laptopfach bis 14 Zoll und zwei Flaschentaschen.",
                            "rucksack-pfad-tag",
                            sku="SO-RUC-1012",
                            gtin="4261100000110",
                            stock=25,
                            variants=[
                                ...
                                {"size": "18 l", "color": "Oliv", "price": "99.00", "stock": 12},
                            ],
                        ),
                        _p(
                            "Hüfttasche „Riegel“ 2 l",
                            "44.00",
                            "Schmale Tasche für Schlüssel, Riegel und Telefon, mit Gurt bis 110 cm Umfang.",
                            "huefttasche-riegel-klein",
                            sku="SO-RUC-1013",
                            gtin="4261100000127",
                            stock=36,
                        ),
                        _p(
                            "Packsack-Set „Ordnung“, 3er",
                            "29.00",
                            "Drei Beutel in 3, 6 und 10 l aus Ripstop, mit Rollverschluss und Sichtfenster.",
                            "packsack-ordnung-set",
                            sku="SO-RUC-1014",
                            gtin="4261100000134",
                            stock=42,
                        ),
                        _p(
                            "Wanderstöcke „Schritt“, Paar",
                            "89.00",
                            "Aluminiumstöcke, dreiteilig, mit Klemmverschluss und Korkgriff. Gepackt 62 cm.",
                            "wanderstoecke-schritt-paar",
                            sku="SO-RUC-1015",
                            gtin="4261100000141",
                            material="Aluminium 7075, Kork",
                            stock=15,
                        ),
                    ],
                    "rucksaecke-touren-wandern",
                ),
                (
                    "Camp & Licht",
                    "camp-licht",
                    [
                        _p(
                            "Zelt „Zwei“ 2-Personen",
                            "279.00",
                            "Kuppelzelt mit zwei Apsiden und 4000 mm Wassersäule, Packmaß 45 × 15 cm, 2,4 kg.",
                            "zelt-zwei-kuppel",
                            sku="SO-CAM-1016",
                            gtin="4261100000158",
                            badge="neu",
                            material="Polyester-Ripstop, Aluminiumgestänge",
                            stock=9,
                        ),
                        _p(
                            "Schlafsack „Nacht“ Komfort 4 °C",
                            "159.00",
                            "Mumienschlafsack mit Kunstfaserfüllung, auch feucht noch wärmend. Reißverschluss beidseitig.",
                            "schlafsack-nacht-mumie",
                            sku="SO-CAM-1017",
                            gtin="4261100000165",
                            stock=12,
                        ),
                        _p(
                            "Isomatte „Boden“ selbstaufblasend",
                            "99.00",
                            "Matte 5 cm, R-Wert 3,4, rollt sich mit dem Ventil in einer Minute selbst auf.",
                            "isomatte-boden-selbst",
                            sku="SO-CAM-1018",
                            gtin="4261100000172",
                            stock=17,
                        ),
                        _p(
                            "Campinglampe „Docht“",
                            "49.00",
                            "Wiederaufladbare Laterne mit warmem Licht, 200 Lumen, dimmbar. Hängt am Bügel im Zelt.",
                            "campinglampe-docht-laterne",
                            sku="SO-CAM-1019",
                            gtin="4261100000189",
                            stock=29,
                        ),
                        _p(
                            "Picknickdecke „Wiese“",
                            "59.00",
                            "Decke 140 × 180 cm mit wasserdichter Unterseite, rollbar zum Tragegurt.",
                            "picknickdecke-wiese-rolle",
                            sku="SO-CAM-1020",
                            gtin="4261100000196",
                            material="Baumwollmischung, PU-Rücken",
                            stock=23,
                            variants=[
                                {
                                    "size": "140 × 180 cm",
            ...
            "Ausrüstung für den Weg vor die Tür: Flaschen, Matten, Rucksäcke und Licht. Reparierbar, nachkaufbar, ohne Elektronik.",
            "",
            "sport-outdoor-uebersicht",
        ),
    ],
    # Наборы: подарочные комплекты из позиций разных направлений — то, чего у
    # магазина-лавки не было вовсе. Состав связывается по немецкому имени товара.
    combos=[
        {
            "name": "Set „Morgen“",
            "description": "Filterkaffee, ein schwerer Becher und ein Notizbuch — "
            "das Paket für die erste Stunde des Tages.",
            "price": "62.00",
            "category": "kaffee-tee",
            "photos": ["set-morgen-tisch", "set-morgen-detail"],
            "groups": [
                {"label": "Kaffee", "included": True, "products": ["Filterkaffee „Morgenlicht“"]},
                {"label": "Becher", "included": True, "products": ["Becher „Faust“ 350 ml"]},
                {"label": "Notizbuch", "included": True, "products": ["Notizbuch „Leinen“ A6"]},
            ],
        },
        {
            "name": "Set „Sofaabend“",
            "description": "Wolldecke, Kissenhülle und Duftkerze — abends nicht mehr aufstehen müssen.",
            "price": "179.00",
            "category": "wohnen-textil",
            "photos": ["set-sofaabend-decke"],
            "groups": [
                {"label": "Decke", "included": True, "products": ["Wolldecke „Fjord“"]},
                {"label": "Kissen", "included": True, "products": ["Kissenhülle „Grasnarbe“"]},
                {"label": "Licht", "included": True, "products": ["Duftkerze „Zeder & Salz“"]},
            ],
        },
        {
            "name": "Set „Tafel für vier“",
            "description": "Teller, Gläser und Besteck für vier Gedecke — eine Bestellung statt vier.",
            "price": "239.00",
            "category": "kueche-tafel",
            "photos": ["set-tafel-gedeckt"],
            "groups": [
                {
                    "label": "Teller",
                    "included": True,
                    "products": ["Teller „Scholle“ flach, 27 cm"],
                },
                {"label": "Gläser", "included": True, "products": ["Trinkglas „Rille“, 6er-Set"]},
                {"label": "Besteck", "included": True, "products": ["Besteck „Gerade“, 16-teilig"]},
            ],
        },
        {
            "name": "Set „Erste Wohnung“",
            "description": "Pfanne, Schneidebrett und drei Geschirrtücher — die Grundausstattung, "
            "die man sonst einzeln vergisst.",
            "price": "169.00",
            "category": "kueche-tafel",
            "photos": ["set-wohnung-kueche"],
            "groups": [
                {
                    "label": "Pfanne",
                    "included": True,
                    "products": ["Gusseisenpfanne „Feuer“ 26 cm"],
                },
                {"label": "Brett", "included": True, "products": ["Schneidebrett „Scheibe“ Eiche"]},
                {"label": "Tücher", "included": True, "products": ["Geschirrtuch „Streifen“, 3er"]},
            ],
        },
        {
            "name": "Set „Schreibtisch“",
            "description": "Notizbuch, Füller und Stiftebecher — abgestimmt, ohne Werbeaufdruck.",
            "price": "129.00",
            "category": "papeterie-buero",
            "photos": ["set-schreibtisch-oben"],
            "groups": [
                {"label": "Notizbuch", "included": True, "products": ["Notizbuch „Leinen“ A5"]},
                {"label": "Stift", "included": True, "products": ["Füller „Halm“"]},
                {"label": "Becher", "included": True, "products": ["Stiftebecher „Rohr“ Messing"]},
            ],
        },
        {
            "name": "Set „Bad“",
            "description": "Seife, Seifenschale und zwei Handtücher — als Einzug- oder Gastgeschenk.",
            "price": "84.00",
            "category": "pflege-bad",
            "photos": ["set-bad-regal"],
            "groups": [
                {"label": "Seife", "included": True, "products": ["Seife „Salzluft“"]},
                {"label": "Schale", "included": True, "products": ["Seifenschale „Rippe“ Eiche"]},
                {
                    "label": "Handtuch",
                    "included": True,
                    "products": ["Handtuch „Frottee“ 50 × 100"],
                },
            ],
        },
    ],
    # Подборки: чипы-фасет листинга; с фото — «луки» со страницей /lookbook/<slug>/.
    collections=[
        (
            "Neu im Herbst",
            {
                "products": [2, 81, 132, 171, 196, 120],
                "photos": ["look-herbst-mantel", "look-herbst-decke", "look-herbst-tisch"],
            },
        ),
        (
            "Naturfasern",
            {
                "products": [0, 2, 81, 83, 85, 86],
                "photos": ["look-naturfaser-leinen", "look-naturfaser-wolle"],
            },
        ),
        (
            "Geschenke unter 30 €",
            {
                "products": [105, 141, 162, 90, 136, 115, 174],
            },
        ),
        (
            "Erste Wohnung",
            {
                "products": [110, 114, 101, 157, 96, 93],
            },
        ),
    ],
    # Акции: все стили вывода (UE2-2) и формы карточки (DL-19), группы = разделы
    # страницы /aktionen/, одна запланированная — в полосу «Vorschau».
    promotions_spec=[
        {
            "title": "Wolldecke „Fjord“ −25 %",
            "product": 81,
            "percent": 25,
            "discount_style": "percent",
            "group": "Wochenangebote",
            "ends_in_days": 7,
            "recurrence": "weekly",
            "desc": "Jede Woche ein Stück aus Wohnen & Textil reduziert.",
            "images": ["aktion-decke-sofa", "look-herbst-decke"],
        },
        {
            ...
            "group": "Wochenangebote",
            "ends_in_days": 10,
            "desc": "Vorjahresfarbe Salbei — Schnitt und Stoff unverändert.",
        },
        {
            ...
            "limit": 40,
            "ends_in_days": 14,
            "desc": "Röstung vom letzten Monat — voll im Aroma, knapp im Datum.",
        },
        {
            ...
            "group": "Räumung",
            "ends_in_days": 21,
            "desc": "Farbe Petrol läuft aus — solange der Vorrat reicht.",
        },
        {
            ...
            "limit": 4,
            "ends_in_days": 3,
            "desc": "Ausstellungsstücke mit kleinen Kratzern am Rahmen.",
        },
        {
            ...
            "group": "Räumung",
            "ends_in_days": 12,
            "desc": "Emaille mit Haarriss in der Glasur außen — funktioniert unverändert.",
        },
        {
            ...
            "group": "Räumung",
            "ends_in_days": 18,
            "desc": "Vorgängerflakon, Inhalt identisch.",
        },
        {
            "title": "Set „Morgen“ −15 %",
            "percent": 15,
            ...
            "group": "Sets & Bundles",
            "ends_in_days": 30,
            "desc": "Kaffee, Becher und Notizbuch zusammen günstiger als einzeln.",
            "image": "set-morgen-tisch",
        },
        {
            "title": "Set „Erste Wohnung“ statt 189 € nur 169 €",
            "new_price": "169.00",
            "compare_at": "189.00",
            "discount_style": "strikethrough",
            "group": "Sets & Bundles",
            "ends_in_days": 45,
            "desc": "Pfanne, Brett und Tücher — die Grundausstattung in einem Karton.",
            "image": "set-wohnung-kueche",
        },
        {
            "title": "Überraschungspaket Papeterie, 24 €",
            "new_price": "24.00",
            "compare_at": "40.00",
            "discount_style": "mystery",
            "surprise": True,
            ...
            "limit": 25,
            "ends_in_days": 20,
            "desc": "Vier Artikel aus Papeterie & Büro im Wert von mindestens 40 € — "
            "welche, sehen Sie beim Auspacken.",
            "image": "aktion-ueberraschung-paket",
        },
        {
            ...
            "new": True,
            "ends_in_days": 9,
            "desc": "Beide Größen, beide Farben.",
        },
        {
            ...
            "group": "Wochenangebote",
            "ends_in_days": 11,
            "desc": "Naturkautschuk, 4 mm — auch für Reisen dünn genug.",
        },
        {
            ...
            "starts_in_days": 3,
            "ends_in_days": 7,
            "desc": "Alle Röstungen und der Espresso, drei Tage lang.",
        },
        {
            ...
            "starts_in_days": 7,
            "ends_in_days": 10,
            "desc": "Korkgriffe, dreiteilig — Vorjahresmodell mit anderem Aufdruck.",
        },
        {
            ...
            "starts_in_days": 5,
            "ends_in_days": 7,
            "desc": "Nächste Woche geht alles aus Wolle in den Preisnachlass.",
        },
    ],
    vouchers=[
        {
            "code": "WILLKOMMEN10",
            "label": "10 % für die erste Bestellung",
            "percent": 10,
            "min_order": 40,
            "max_uses": 200,
        },
    ...
    reviews_seed=[
        (
            5,
            "Bestellt am Dienstag, Donnerstag da. Die Wolldecke ist genau so schwer, wie beschrieben.",
            "os.becker@example.de",
        ),
        (
            5,
            "Retoure ohne Diskussion, Geld nach zwei Tagen zurück. Gerne wieder.",
            "os.ilyas@example.de",
        ),
        (
            4,
            "Sehr gute Auswahl; bei der Kaffeemühle hätte ich mir mehr Fotos gewünscht.",
            "os.brandt@example.de",
        ),
        (
            5,
            "Endlich ein Shop mit ehrlichen Größentabellen — passt auf Anhieb.",
            "os.novak@example.de",
        ),
    ],
    product_reviews=[
        (
            ...
            "Familie Becker",
            "os.becker@example.de",
            "Dritte Bestellung. Läuft nicht ein, verzieht sich nicht.",
        ),
        (
            0,
            4,
            "Nadine H.",
            "os.nadine@example.de",
            "Sitzt gut, Creme ist etwas durchsichtiger als erwartet.",
        ),
        (81, 5, "Tarek A.", "os.tarek@example.de", "Schwer und warm, kratzt kein bisschen."),
        (81, 5, "Ines B.", "os.ines@example.de", "Liegt seit Oktober auf dem Sofa und bleibt da."),
        (
            110,
            5,
            "Jörg M.",
            "os.joerg@example.de",
            "Eingebrannt geliefert, Spiegelei rutscht ab Tag eins.",
        ),
        (
            110,
            4,
            "Silke R.",
            "os.silke@example.de",
            "Sehr gut, aber wirklich schwer — mit einer Hand nichts.",
        ),
        (
            121,
            5,
            "Peer L.",
            "os.peer@example.de",
            "Röstdatum war zehn Tage alt. Genau so soll das sein.",
        ),
        (
            121,
            4,
            "Anja K.",
            "os.anja@example.de",
            "Fein säuerlich; für Espresso zu hell, für Filter top.",
        ),
        (161, 5, "Marc W.", "os.marc@example.de", "Füller schlägt nicht durch, liegt flach auf."),
        (
            161,
            5,
            "Ute F.",
            "os.ute@example.de",
            "Papier ist deutlich besser als bei den bekannten Marken.",
        ),
        (
            181,
            4,
            "Bea S.",
            "os.bea@example.de",
            "Dicht und geschmacksneutral, aber nicht isoliert — das steht aber dabei.",
        ),
        (
            101,
            5,
            "Familie Osterloh",
            "os.osterloh@example.de",
            "Vier Stück seit einem Jahr in der Spülmaschine, kein Kratzer.",
        ),
        (141, 5, "Lea D.", "os.lea@example.de", "Hält ewig und trocknet die Hände nicht aus."),
        (191, 4, "Malte P.", "os.malte@example.de", "Guter Rücken, Regenhülle etwas dünn."),
        (
            122,
            5,
            "Sven O.",
            "os.sven@example.de",
            "Schokoladig, steht in Milch. Genau wie versprochen.",
        ),
        (
            85,
            5,
            "Christiane V.",
            "os.christiane@example.de",
            "Nach der dritten Wäsche unschlagbar weich.",
        ),
        (
            132,
            4,
            "Rüdiger E.",
            "os.ruediger@example.de",
            "Mahlt gleichmäßig; für 30 g braucht man etwas Geduld.",
        ),
        (
            83,
            5,
            "Marlen T.",
            "os.marlen@example.de",
            "Leinen wie beschrieben, Reißverschluss sauber verdeckt.",
        ),
    ],
    combo_reviews=[
        (
            ...
            "Familie Becker",
            "os.becker@example.de",
            "Als Geschenk verschickt, kam fertig verpackt an.",
        ),
        (
            1,
            5,
            "Ines B.",
            "os.ines@example.de",
            "Decke, Kissen und Kerze passen farblich wirklich zusammen.",
        ),
        (
            2,
            4,
            "Tarek A.",
            "os.tarek@example.de",
            "Gutes Set; ein zweiter Satz Gläser wäre praktisch gewesen.",
        ),
    ],
    blog_posts=[
        (
            "Warum wir keine Mischgewebe führen",
            "Baumwolle mit Polyester hält kürzer, als man denkt — und lässt sich nicht recyceln.",
            "Ein T-Shirt aus 60 % Baumwolle und 40 % Polyester fühlt sich im Laden gut an: "
            "es knittert weniger und trocknet schneller. Nach zwanzig Wäschen sieht man den "
            "Unterschied trotzdem — die Baumwolle scheuert ab, das Polyester bleibt und "
            "bildet Knötchen. Recyceln lässt sich das Gemisch bis heute nicht, weil beide "
            "Fasern chemisch getrennt werden müssten. Deshalb steht bei uns auf jedem "
            "Textil die volle Zusammensetzung, und wir führen Mischgewebe nur dort, wo es "
            "technisch nötig ist: bei Sporthandtüchern und beim Ringel-Longsleeve, das "
            "5 % Elasthan braucht, um in Form zu bleiben.",
            "blog-mischgewebe-stoff",
        ),
        (
            "Was „Grundpreis“ auf unseren Etiketten bedeutet",
            "Bei Kaffee, Tee und Pflege steht neben dem Preis der Preis je Kilo oder Liter.",
            "Die Preisangabenverordnung schreibt vor, dass bei Waren mit Gewichts- oder "
            "Volumenangabe zusätzlich der Grundpreis genannt wird — also der Preis je "
            "Kilogramm oder Liter. Das klingt nach Bürokratie, ist aber das einzige "
            "Werkzeug, mit dem man 250-g-Tüten und 1-kg-Beutel wirklich vergleichen kann. "
            "Bei uns steht der Grundpreis auf der Karte, in der Liste und im Warenkorb, "
            "und er ändert sich mit, wenn eine Aktion läuft.",
            "blog-grundpreis-etikett",
        ),
        (
            "Ersatzteile statt Neukauf",
            "Für Rasierhobel, Mühlen und Rucksäcke halten wir Einzelteile vor.",
            "Ein Rucksack fällt selten komplett aus — meistens reißt ein Gurtband oder "
            "ein Steckschloss bricht. Wir haben deshalb für die Modelle „Grat“ und „Pfad“ "
            "Schnallen, Hüftgurte und Regenhüllen einzeln im Lager, ebenso Mahlwerke für "
            "die Handmühle und Klingen für den Rasierhobel. Schreiben Sie uns, welches "
            "Teil fehlt; in der Regel ist es innerhalb einer Woche bei Ihnen.",
            "blog-ersatzteile-werkbank",
        ),
    ],
)
...
KITS = {
    ...
    ONLINE_SHOP.key: ONLINE_SHOP,  # 2026-09-03: dedicated-демо интернет-магазина
}
...
def apply_kit(tenant, key: str) -> bool:
    ...
    def _make_product(item, category):
        ...
        for vsort, v in enumerate(item["variants"]):
            ...
            if isinstance(v, dict):
                vc = v.get("content")
                # Цена варианта необязательна: у одежды все размеры одного цвета
                # стоят как товар, и дублировать её пятнадцать раз — только шанс
                # разъехаться. Своя цена нужна лишь там, где размер её меняет.
                vprice = Decimal(str(v.get("price", item["price"])))
                vstock = v.get("stock")
    ...
    if kit.payments:
        ...
        if pay.get("vorkasse"):
            ...
            tenant.bank_holder = pay.get("bank_holder", "")
            tenant.bank_iban = pay.get("bank_iban", "")
            tenant.bank_bic = pay.get("bank_bic", "")
            update_fields += ["vorkasse_enabled", "bank_holder", "bank_iban", "bank_bic"]
        if pay.get("invoice_b2b"):
            tenant.invoice_b2b_enabled = True
            update_fields.append("invoice_b2b_enabled")
    if kit.address:
