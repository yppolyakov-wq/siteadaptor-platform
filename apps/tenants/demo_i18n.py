...
# LAY-6b: владелец реестра — `siteconfig` (тот же список читает разбор Save в
# редакторе). Здесь только псевдоним, чтобы обход и редактор не разъехались.
from .siteconfig import TRANSLATABLE_KEYS as _TRANSLATABLE_CONFIG_KEYS  # noqa: E402
